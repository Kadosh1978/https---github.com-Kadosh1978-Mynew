# encoding: utf-8
# module lxml.sax
# from /home/kadosh/PycharmProjects/Weather/venv/lib/python3.10/site-packages/lxml/sax.cpython-310-x86_64-linux-gnu.so
# by generator 1.147
"""
...
class ContentHandler(object):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'xml.sax.handler', '__doc__': 'Interface for receiving logical document content events.\\n\\n    This is the main callback interface in SAX, and the one most\\n    important to applications. The order of events in this interface\\n    mirrors the order of the information in the document.', '__init__': <function ContentHandler.__init__ at 0x7f717f8eb880>, 'setDocumentLocator': <function ContentHandler.setDocumentLocator at 0x7f717f8eb910>, 'startDocument': <function ContentHandler.startDocument at 0x7f717f8eb9a0>, 'endDocument': <function ContentHandler.endDocument at 0x7f717f8eba30>, 'startPrefixMapping': <function ContentHandler.startPrefixMapping at 0x7f717f8ebac0>, 'endPrefixMapping': <function ContentHandler.endPrefixMapping at 0x7f717f8ebb50>, 'startElement': <function ContentHandler.startElement at 0x7f717f8ebbe0>, 'endElement': <function ContentHandler.endElement at 0x7f717f8ebc70>, 'startElementNS': <function ContentHandler.startElementNS at 0x7f717f8ebd00>, 'endElementNS': <function ContentHandler.endElementNS at 0x7f717f8ebd90>, 'characters': <function ContentHandler.characters at 0x7f717f8ebe20>, 'ignorableWhitespace': <function ContentHandler.ignorableWhitespace at 0x7f717f8ebeb0>, 'processingInstruction': <function ContentHandler.processingInstruction at 0x7f717f8ebf40>, 'skippedEntity': <function ContentHandler.skippedEntity at 0x7f717f910040>, '__dict__': <attribute '__dict__' of 'ContentHandler' objects>, '__weakref__': <attribute '__weakref__' of 'ContentHandler' objects>})"
...
class ElementTreeProducer(object):
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x7f717fa45c80>'
...
__pyx_capi__ = {
    '_getNsTag': None, # (!) real value is '<capsule object "PyObject *(PyObject *)" at 0x7f717fa45c50>'
}

__spec__ = None # (!) real value is "ModuleSpec(name='lxml.sax', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f717fa45c30>, origin='/home/kadosh/PycharmProjects/Weather/venv/lib/python3.10/site-packages/lxml/sax.cpython-310-x86_64-linux-gnu.so')"
