...
class QuerySitesByCost(__talloc.BaseObject):
    # no doc
    @classmethod
    def opnum(cls): # real signature unknown; restored from __doc__
        """ drsuapi.QuerySitesByCost.opnum() -> 24 (0x18) """
        pass
    ...
    """PIDL-generated element of base type drsuapi_QuerySitesByCostRequest"""

    out_ctr = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type drsuapi_QuerySitesByCostCtr"""
