...
class DsGetMemberships2(__talloc.BaseObject):
    # no doc
    @classmethod
    def opnum(cls): # real signature unknown; restored from __doc__
        """ drsuapi.DsGetMemberships2.opnum() -> 21 (0x15) """
        pass
    ...
    """PIDL-generated element of base type drsuapi_DsGetMemberships2Request"""

    out_ctr = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type drsuapi_DsGetMemberships2Ctr"""
