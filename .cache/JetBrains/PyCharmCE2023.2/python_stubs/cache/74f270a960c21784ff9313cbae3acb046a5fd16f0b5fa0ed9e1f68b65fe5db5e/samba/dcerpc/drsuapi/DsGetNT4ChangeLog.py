...
class DsGetNT4ChangeLog(__talloc.BaseObject):
    # no doc
    @classmethod
    def opnum(cls): # real signature unknown; restored from __doc__
        """ drsuapi.DsGetNT4ChangeLog.opnum() -> 11 (0x0b) """
        pass
    ...
    """PIDL-generated element of base type drsuapi_DsGetNT4ChangeLogRequest"""

    out_info = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type drsuapi_DsGetNT4ChangeLogInfo"""
