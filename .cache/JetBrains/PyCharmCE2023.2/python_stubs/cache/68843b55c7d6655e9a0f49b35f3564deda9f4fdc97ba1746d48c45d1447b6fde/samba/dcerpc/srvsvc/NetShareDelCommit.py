...
class NetShareDelCommit(__talloc.BaseObject):
    # no doc
    @classmethod
    def opnum(cls): # real signature unknown; restored from __doc__
        """ srvsvc.NetShareDelCommit.opnum() -> 38 (0x26) """
        pass
    ...
    in_hnd = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
