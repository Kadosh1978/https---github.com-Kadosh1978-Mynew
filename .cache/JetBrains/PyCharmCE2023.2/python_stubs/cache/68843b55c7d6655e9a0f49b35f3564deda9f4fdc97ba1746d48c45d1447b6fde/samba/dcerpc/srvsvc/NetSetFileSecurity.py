...
class NetSetFileSecurity(__talloc.BaseObject):
    # no doc
    @classmethod
    def opnum(cls): # real signature unknown; restored from __doc__
        """ srvsvc.NetSetFileSecurity.opnum() -> 40 (0x28) """
        pass
    ...
    in_sd_buf = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
