...
class NetServerTransportAddEx(__talloc.BaseObject):
    # no doc
    @classmethod
    def opnum(cls): # real signature unknown; restored from __doc__
        """ srvsvc.NetServerTransportAddEx.opnum() -> 41 (0x29) """
        pass
    ...
    """PIDL-generated element of base type srvsvc_NetTransportInfo"""
