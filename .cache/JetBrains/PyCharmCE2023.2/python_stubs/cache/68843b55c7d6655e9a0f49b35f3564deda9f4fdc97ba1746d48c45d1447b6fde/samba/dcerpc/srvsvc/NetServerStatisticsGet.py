...
class NetServerStatisticsGet(__talloc.BaseObject):
    # no doc
    @classmethod
    def opnum(cls): # real signature unknown; restored from __doc__
        """ srvsvc.NetServerStatisticsGet.opnum() -> 24 (0x18) """
        pass
    ...
    out_stats = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type srvsvc_Statistics"""
