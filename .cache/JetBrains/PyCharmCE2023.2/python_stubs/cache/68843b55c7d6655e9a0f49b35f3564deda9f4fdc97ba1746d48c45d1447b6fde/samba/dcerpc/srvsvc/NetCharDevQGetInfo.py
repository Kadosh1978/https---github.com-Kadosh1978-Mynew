...
class NetCharDevQGetInfo(__talloc.BaseObject):
    # no doc
    @classmethod
    def opnum(cls): # real signature unknown; restored from __doc__
        """ srvsvc.NetCharDevQGetInfo.opnum() -> 4 (0x04) """
        pass
    ...
    in_queue_name = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    ...
    """PIDL-generated element of base type srvsvc_NetCharDevQInfo"""
