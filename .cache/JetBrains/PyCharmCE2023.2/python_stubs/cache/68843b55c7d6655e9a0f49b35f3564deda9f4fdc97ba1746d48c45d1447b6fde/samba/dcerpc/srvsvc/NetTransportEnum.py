...
class NetTransportEnum(__talloc.BaseObject):
    # no doc
    @classmethod
    def opnum(cls): # real signature unknown; restored from __doc__
        """ srvsvc.NetTransportEnum.opnum() -> 26 (0x1a) """
        pass
    ...
    in_transports = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type srvsvc_NetTransportInfoCtr"""
    ...
    out_transports = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type srvsvc_NetTransportInfoCtr"""
