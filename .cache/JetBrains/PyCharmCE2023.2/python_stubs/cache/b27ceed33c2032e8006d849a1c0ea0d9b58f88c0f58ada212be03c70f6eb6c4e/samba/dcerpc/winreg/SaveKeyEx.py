...
class SaveKeyEx(__talloc.BaseObject):
    # no doc
    @classmethod
    ...
    in_filename = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    ...
    in_sec_attrib = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type KeySecurityAttribute"""
