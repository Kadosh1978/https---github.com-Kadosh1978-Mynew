...
class OpenKey(__talloc.BaseObject):
    # no doc
    @classmethod
    ...
    in_keyname = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    ...
    in_parent_handle = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
