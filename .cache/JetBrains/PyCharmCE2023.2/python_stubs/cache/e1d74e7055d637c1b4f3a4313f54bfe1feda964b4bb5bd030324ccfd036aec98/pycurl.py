# encoding: utf-8
# module pycurl
# from /usr/lib/python3/dist-packages/pycurl.cpython-310-x86_64-linux-gnu.so
# by generator 1.147
"""
...
COMPILE_LIBCURL_VERSION_NUM = 479488

COMPILE_PY_VERSION_HEX = 50988016
...
version = 'PycURL/7.44.1 libcurl/7.81.0 GnuTLS/3.7.3 zlib/1.2.11 brotli/1.0.9 zstd/1.4.8 libidn2/2.3.2 libpsl/0.21.0 (+libidn2/2.3.2) libssh/0.9.6/openssl/zlib nghttp2/1.43.0 librtmp/2.3 OpenLDAP/2.5.16'
...
class CurlMulti(object):
    ...
    def assign(self, sock_fd, p_object): # real signature unknown; restored from __doc__
        """
    ...
    def socket_action(self, sock_fd, ev_bitmask): # real signature unknown; restored from __doc__
        """
...
class CurlSockAddr(tuple):
    ...
    addr = _tuplegetter(3, 'Alias for field number 3')
    family = _tuplegetter(0, 'Alias for field number 0')
    protocol = _tuplegetter(2, 'Alias for field number 2')
    socktype = _tuplegetter(1, 'Alias for field number 1')
    _fields = (
        'family',
        'socktype',
        'protocol',
...
class KhKey(tuple):
    ...
    keytype = _tuplegetter(1, 'Alias for field number 1')
    _fields = (
        'key',
        'keytype',
    )
...
__spec__ = None # (!) real value is "ModuleSpec(name='pycurl', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f4211d2db40>, origin='/usr/lib/python3/dist-packages/pycurl.cpython-310-x86_64-linux-gnu.so')"
