...
class wbint_Sids2UnixIDs(__talloc.BaseObject):
    # no doc
    @classmethod
    ...
    in_domains = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type lsa_RefDomainList"""

    in_ids = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type wbint_TransIDArray"""

    out_ids = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type wbint_TransIDArray"""
