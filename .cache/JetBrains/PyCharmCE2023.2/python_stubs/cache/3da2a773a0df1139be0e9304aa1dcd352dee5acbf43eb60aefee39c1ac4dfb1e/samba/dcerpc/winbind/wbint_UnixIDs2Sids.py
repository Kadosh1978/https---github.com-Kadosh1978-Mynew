...
class wbint_UnixIDs2Sids(__talloc.BaseObject):
    # no doc
    @classmethod
    ...
    in_num_ids = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type uint32"""

    in_xids = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    ...
    out_xids = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type unixid"""
