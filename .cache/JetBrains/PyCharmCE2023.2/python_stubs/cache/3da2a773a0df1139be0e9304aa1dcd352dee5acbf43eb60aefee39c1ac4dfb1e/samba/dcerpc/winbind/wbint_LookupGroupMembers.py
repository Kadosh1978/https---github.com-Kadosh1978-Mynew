...
class wbint_LookupGroupMembers(__talloc.BaseObject):
    # no doc
    @classmethod
    ...
    out_members = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type wbint_Principals"""
