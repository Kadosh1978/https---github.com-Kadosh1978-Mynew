...
class wbint_LookupRids(__talloc.BaseObject):
    # no doc
    @classmethod
    ...
    """PIDL-generated element of base type wbint_RidArray"""

    out_domain_name = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
