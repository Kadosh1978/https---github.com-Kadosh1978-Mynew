...
class wbint_LookupSid(__talloc.BaseObject):
    # no doc
    @classmethod
    ...
    out_domain = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    ...
    """PIDL-generated element of base type lsa_SidType"""
