...
# from /home/kadosh/PycharmProjects/Weather/venv/lib/python3.10/site-packages/lxml/html/diff.cpython-310-x86_64-linux-gnu.so
# by generator 1.147
# no doc

# imports
import builtins as __builtins__ # <module 'builtins' (built-in)>
import difflib as difflib # /usr/lib/python3.10/difflib.py
...
class token(str):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'lxml.html.diff', '__doc__': ' Represents a diffable token, generally a word that is displayed to\\n    the user.  Opening tags are attached to this token when they are\\n    adjacent (pre_tags) and closing tags that follow the word\\n    (post_tags).  Some exceptions occur when there are empty tags\\n    adjacent to a word, so there may be close tags in pre_tags, or\\n    open tags in post_tags.\\n\\n    We also keep track of whether the word was originally followed by\\n    whitespace, even though we do not want to treat the word as\\n    equivalent to a similar word that does not have a trailing\\n    space.', 'hide_when_equal': False, '__new__': <cyfunction token.__new__ at 0x7f717f289e50>, '__repr__': <cyfunction token.__repr__ at 0x7f717f289f20>, 'html': <cyfunction token.html at 0x7f717f289ff0>, '__dict__': <attribute '__dict__' of 'token' objects>, '__weakref__': <attribute '__weakref__' of 'token' objects>})"
...
__spec__ = None # (!) real value is "ModuleSpec(name='lxml.html.diff', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f717fa46ce0>, origin='/home/kadosh/PycharmProjects/Weather/venv/lib/python3.10/site-packages/lxml/html/diff.cpython-310-x86_64-linux-gnu.so')"
