...
openssl_md_meth_names = None # (!) real value is "frozenset({'shake_128', 'sha224', 'blake2b', 'md5-sha1', 'sha1', 'sha384', 'sha512_256', 'sha3_224', 'sha3_256', 'sm3', 'md5', 'sha3_512', 'blake2s', 'shake_256', 'sha3_384', 'sha256', 'sha512', 'sha512_224'})"
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f4ab85fa2c0>'

__spec__ = None # (!) real value is "ModuleSpec(name='_hashlib', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f4ab85fa2c0>, origin='/usr/lib/python3.10/lib-dynload/_hashlib.cpython-310-x86_64-linux-gnu.so')"
