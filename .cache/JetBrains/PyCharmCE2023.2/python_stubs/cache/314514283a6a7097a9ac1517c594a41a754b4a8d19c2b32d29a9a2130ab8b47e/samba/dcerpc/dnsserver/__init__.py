...
from .dnsserver_abstract_syntax import dnsserver_abstract_syntax
from .abstract_syntax import abstract_syntax
from .dnsserver import dnsserver
from .DnssrvComplexOperation import DnssrvComplexOperation
from .DnssrvComplexOperation2 import DnssrvComplexOperation2
from .DnssrvEnumRecords import DnssrvEnumRecords
from .DnssrvEnumRecords2 import DnssrvEnumRecords2
from .DnssrvOperation import DnssrvOperation
from .DnssrvOperation2 import DnssrvOperation2
from .DnssrvQuery import DnssrvQuery
from .DnssrvQuery2 import DnssrvQuery2
from .DnssrvUpdateRecord import DnssrvUpdateRecord
from .DnssrvUpdateRecord2 import DnssrvUpdateRecord2
from .DNSSRV_RPC_UNION import DNSSRV_RPC_UNION
...
from .DNS_RPC_RECORD_DATA import DNS_RPC_RECORD_DATA
...
__spec__ = None # (!) real value is "ModuleSpec(name='samba.dcerpc.dnsserver', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f4211d2db40>, origin='/usr/lib/python3/dist-packages/samba/dcerpc/dnsserver.cpython-310-x86_64-linux-gnu.so')"
