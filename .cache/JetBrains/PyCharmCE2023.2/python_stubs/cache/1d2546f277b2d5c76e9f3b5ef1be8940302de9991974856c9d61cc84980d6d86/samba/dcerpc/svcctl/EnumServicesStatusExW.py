...
class EnumServicesStatusExW(__talloc.BaseObject):
    # no doc
    @classmethod
    def opnum(cls): # real signature unknown; restored from __doc__
        """ svcctl.EnumServicesStatusExW.opnum() -> 42 (0x2a) """
        pass
    ...
    in_group_name = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
