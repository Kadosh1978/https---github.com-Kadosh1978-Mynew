...
class CreateServiceW(__talloc.BaseObject):
    # no doc
    @classmethod
    ...
    in_dependencies_size = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    ...
    in_password_size = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type uint32"""

    in_scmanager_handle = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    ...
    in_TagId = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type uint32"""
