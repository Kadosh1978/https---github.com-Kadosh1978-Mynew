...
class epm_Map(__talloc.BaseObject):
    # no doc
    @classmethod
    ...
    in_map_tower = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type epm_twr_t"""

    in_max_towers = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    ...
    out_num_towers = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type uint32"""

    out_towers = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type epm_twr_p_t"""
