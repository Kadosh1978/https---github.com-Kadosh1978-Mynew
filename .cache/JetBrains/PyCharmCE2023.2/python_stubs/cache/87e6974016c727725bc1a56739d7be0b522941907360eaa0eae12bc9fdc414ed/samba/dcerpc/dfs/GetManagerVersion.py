...
class GetManagerVersion(__talloc.BaseObject):
    # no doc
    @classmethod
    ...
    out_version = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type dfs_ManagerVersion"""
