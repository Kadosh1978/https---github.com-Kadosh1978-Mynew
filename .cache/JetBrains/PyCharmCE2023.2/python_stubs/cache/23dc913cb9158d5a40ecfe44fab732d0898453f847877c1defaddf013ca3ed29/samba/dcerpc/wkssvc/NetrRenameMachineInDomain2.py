...
class NetrRenameMachineInDomain2(__talloc.BaseObject):
    # no doc
    @classmethod
    ...
    in_NewMachineName = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type uint16"""

    in_RenameOptions = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type wkssvc_renameflags"""
