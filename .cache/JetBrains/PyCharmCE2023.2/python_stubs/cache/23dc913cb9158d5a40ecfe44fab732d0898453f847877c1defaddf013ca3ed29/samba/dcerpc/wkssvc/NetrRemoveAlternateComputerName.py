...
class NetrRemoveAlternateComputerName(__talloc.BaseObject):
    # no doc
    @classmethod
    def opnum(cls): # real signature unknown; restored from __doc__
        """ wkssvc.NetrRemoveAlternateComputerName.opnum() -> 28 (0x1c) """
        pass
    ...
    in_AlternateMachineNameToRemove = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type uint16"""
