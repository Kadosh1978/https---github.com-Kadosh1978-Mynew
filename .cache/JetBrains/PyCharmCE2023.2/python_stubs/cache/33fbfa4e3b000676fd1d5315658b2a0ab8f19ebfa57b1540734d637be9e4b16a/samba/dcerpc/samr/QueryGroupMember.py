...
class QueryGroupMember(__talloc.BaseObject):
    # no doc
    @classmethod
    ...
    out_rids = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type samr_RidAttrArray"""
