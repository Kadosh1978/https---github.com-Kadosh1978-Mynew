...
class QueryDomainInfo2(__talloc.BaseObject):
    # no doc
    @classmethod
    def opnum(cls): # real signature unknown; restored from __doc__
        """ samr.QueryDomainInfo2.opnum() -> 46 (0x2e) """
        pass
    ...
    """PIDL-generated element of base type samr_DomainInfoClass"""

    out_info = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type samr_DomainInfo"""
