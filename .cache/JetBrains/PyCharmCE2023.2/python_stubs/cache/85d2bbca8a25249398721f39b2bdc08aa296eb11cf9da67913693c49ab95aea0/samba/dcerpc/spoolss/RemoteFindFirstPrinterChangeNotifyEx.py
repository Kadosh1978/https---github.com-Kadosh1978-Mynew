...
class RemoteFindFirstPrinterChangeNotifyEx(__talloc.BaseObject):
    # no doc
    @classmethod
    def opnum(cls): # real signature unknown; restored from __doc__
        """ spoolss.RemoteFindFirstPrinterChangeNotifyEx.opnum() -> 65 (0x41) """
        pass
    ...
    in_local_machine = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type uint16"""

    in_notify_options = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    ...
    in_printer_local = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type uint32"""
