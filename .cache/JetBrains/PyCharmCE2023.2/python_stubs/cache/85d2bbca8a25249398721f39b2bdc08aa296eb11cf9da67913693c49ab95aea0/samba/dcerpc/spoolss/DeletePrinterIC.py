...
class DeletePrinterIC(__talloc.BaseObject):
    # no doc
    @classmethod
    def opnum(cls): # real signature unknown; restored from __doc__
        """ spoolss.DeletePrinterIC.opnum() -> 42 (0x2a) """
        pass
    ...
    in_gdi_handle = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
