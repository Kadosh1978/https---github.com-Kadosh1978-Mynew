...
class OpenPrinterEx(__talloc.BaseObject):
    # no doc
    @classmethod
    def opnum(cls): # real signature unknown; restored from __doc__
        """ spoolss.OpenPrinterEx.opnum() -> 69 (0x45) """
        pass
    ...
    """PIDL-generated element of base type spoolss_AccessRights"""

    in_datatype = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    ...
    in_printername = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type uint16"""
