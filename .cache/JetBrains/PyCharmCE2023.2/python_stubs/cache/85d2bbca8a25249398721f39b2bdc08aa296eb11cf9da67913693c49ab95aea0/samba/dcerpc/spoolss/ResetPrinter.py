...
class ResetPrinter(__talloc.BaseObject):
    # no doc
    @classmethod
    def opnum(cls): # real signature unknown; restored from __doc__
        """ spoolss.ResetPrinter.opnum() -> 52 (0x34) """
        pass
    ...
    in_data_type = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
