...
class PrinterEnumValues(__talloc.BaseObject):
    # no doc
    ...
    data_length = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    ...
    value_name_len = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type uint32"""
