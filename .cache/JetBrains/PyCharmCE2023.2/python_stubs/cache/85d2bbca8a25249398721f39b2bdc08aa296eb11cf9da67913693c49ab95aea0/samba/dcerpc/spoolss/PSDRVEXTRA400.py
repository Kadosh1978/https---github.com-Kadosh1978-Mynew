...
class PSDRVEXTRA400(__talloc.BaseObject):
    # no doc
    ...
    aubOptions = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    ...
    wChecksum = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type uint16"""

    wchEPSFile = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type uint32"""

    wOptions = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type uint16"""
