...
class AddPortEx(__talloc.BaseObject):
    # no doc
    @classmethod
    def opnum(cls): # real signature unknown; restored from __doc__
        """ spoolss.AddPortEx.opnum() -> 61 (0x3d) """
        pass
    ...
    in_monitor_name = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type uint16"""

    in_port_ctr = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type spoolss_SetPortInfoContainer"""

    in_port_var_ctr = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
