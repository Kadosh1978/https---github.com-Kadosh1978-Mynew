...
_C_API = None # (!) real value is '<capsule object "cffi" at 0x7f4211d2d9e0>'

__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f4211d2dba0>'

__spec__ = None # (!) real value is "ModuleSpec(name='_cffi_backend', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f4211d2dba0>, origin='/usr/lib/python3/dist-packages/_cffi_backend.cpython-310-x86_64-linux-gnu.so')"
