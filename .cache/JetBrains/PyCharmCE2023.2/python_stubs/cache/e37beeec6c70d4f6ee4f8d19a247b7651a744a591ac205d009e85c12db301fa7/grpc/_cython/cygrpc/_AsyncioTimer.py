...
class _AsyncioTimer(object):
    # no doc
    def on_time_up(self, *args, **kwargs): # real signature unknown
        pass
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x7f4211a6b9f0>'
