...
class ForkManagedThread(object):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'grpc._cython.cygrpc', '__init__': <cyfunction ForkManagedThread.__init__ at 0x7f4211b1af60>, 'setDaemon': <cyfunction ForkManagedThread.setDaemon at 0x7f4211b1b100>, 'start': <cyfunction ForkManagedThread.start at 0x7f4211b1b510>, 'join': <cyfunction ForkManagedThread.join at 0x7f4211b1b780>, '__dict__': <attribute '__dict__' of 'ForkManagedThread' objects>, '__weakref__': <attribute '__weakref__' of 'ForkManagedThread' objects>, '__doc__': None})"
