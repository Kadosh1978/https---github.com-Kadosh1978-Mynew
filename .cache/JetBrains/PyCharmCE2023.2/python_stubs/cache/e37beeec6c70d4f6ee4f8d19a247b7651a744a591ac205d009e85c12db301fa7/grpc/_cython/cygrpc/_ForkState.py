...
class _ForkState(object):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'grpc._cython.cygrpc', '__init__': <cyfunction _ForkState.__init__ at 0x7f4211b1bb90>, '__dict__': <attribute '__dict__' of '_ForkState' objects>, '__weakref__': <attribute '__weakref__' of '_ForkState' objects>, '__doc__': None})"
