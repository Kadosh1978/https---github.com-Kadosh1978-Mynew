...
class _EOF(object):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'grpc._cython.cygrpc', '__bool__': <cyfunction _EOF.__bool__ at 0x7f42112b8380>, '__len__': <cyfunction _EOF.__len__ at 0x7f42112b82b0>, '_repr': <cyfunction _EOF._repr at 0x7f42112b85f0>, '__repr__': <cyfunction _EOF.__repr__ at 0x7f42112b8860>, '__str__': <cyfunction _EOF.__str__ at 0x7f42112b8ad0>, '__dict__': <attribute '__dict__' of '_EOF' objects>, '__weakref__': <attribute '__weakref__' of '_EOF' objects>, '__doc__': None})"
