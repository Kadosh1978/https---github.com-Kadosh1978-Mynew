...
class RemovePrivilegesFromAccount(__talloc.BaseObject):
    # no doc
    @classmethod
    ...
    in_privs = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type lsa_PrivilegeSet"""

    in_remove_all = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
