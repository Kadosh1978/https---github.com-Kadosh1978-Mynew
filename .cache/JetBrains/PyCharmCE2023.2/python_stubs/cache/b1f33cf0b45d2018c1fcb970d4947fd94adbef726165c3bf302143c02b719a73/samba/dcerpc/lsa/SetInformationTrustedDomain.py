...
class SetInformationTrustedDomain(__talloc.BaseObject):
    # no doc
    @classmethod
    ...
    """PIDL-generated element of base type lsa_TrustedDomainInfo"""

    in_level = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type lsa_TrustDomInfoEnum"""

    in_trustdom_handle = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
