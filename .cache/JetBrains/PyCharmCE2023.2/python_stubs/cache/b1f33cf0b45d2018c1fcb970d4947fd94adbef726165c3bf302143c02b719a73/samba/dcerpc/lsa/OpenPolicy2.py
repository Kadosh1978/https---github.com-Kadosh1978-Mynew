...
class OpenPolicy2(__talloc.BaseObject):
    # no doc
    @classmethod
    ...
    """PIDL-generated element of base type lsa_PolicyAccessMask"""

    in_attr = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type lsa_ObjectAttribute"""
