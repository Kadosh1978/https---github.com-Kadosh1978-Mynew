...
class CreateSecret(__talloc.BaseObject):
    # no doc
    @classmethod
    ...
    """PIDL-generated element of base type lsa_SecretAccessMask"""
    ...
    out_sec_handle = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type policy_handle"""
