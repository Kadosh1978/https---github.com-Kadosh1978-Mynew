...
class lsaRSetForestTrustInformation(__talloc.BaseObject):
    # no doc
    @classmethod
    ...
    in_check_only = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type uint8"""

    in_forest_trust_info = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type lsa_ForestTrustInformation"""
    ...
    in_highest_record_type = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type lsa_ForestTrustRecordType"""

    in_trusted_domain_name = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type lsa_StringLarge"""

    out_collision_info = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type lsa_ForestTrustCollisionInfo"""
