...
class CreateTrustedDomainEx2(__talloc.BaseObject):
    # no doc
    @classmethod
    ...
    """PIDL-generated element of base type lsa_TrustedAccessMask"""

    in_auth_info_internal = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type lsa_TrustDomainInfoAuthInfoInternal"""

    in_info = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type lsa_TrustDomainInfoInfoEx"""

    in_policy_handle = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type policy_handle"""

    out_trustdom_handle = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type policy_handle"""
