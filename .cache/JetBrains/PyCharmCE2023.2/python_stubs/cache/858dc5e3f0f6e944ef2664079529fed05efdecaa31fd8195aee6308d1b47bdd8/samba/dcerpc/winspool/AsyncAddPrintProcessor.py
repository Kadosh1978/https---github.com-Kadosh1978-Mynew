...
class AsyncAddPrintProcessor(__talloc.BaseObject):
    # no doc
    @classmethod
    def opnum(cls): # real signature unknown; restored from __doc__
        """ winspool.AsyncAddPrintProcessor.opnum() -> 44 (0x2c) """
        pass
    ...
    in_pPathName = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type uint16"""
