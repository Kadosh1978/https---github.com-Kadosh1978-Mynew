...
class AsyncEnumPorts(__talloc.BaseObject):
    # no doc
    @classmethod
    def opnum(cls): # real signature unknown; restored from __doc__
        """ winspool.AsyncEnumPorts.opnum() -> 47 (0x2f) """
        pass
    ...
    in_pPort = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    ...
    out_pPort = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type uint8"""
