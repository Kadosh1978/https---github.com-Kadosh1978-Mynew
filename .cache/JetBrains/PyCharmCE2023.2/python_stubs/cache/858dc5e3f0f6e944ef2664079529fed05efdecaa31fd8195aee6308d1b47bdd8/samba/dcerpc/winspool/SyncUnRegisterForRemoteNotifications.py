...
class SyncUnRegisterForRemoteNotifications(__talloc.BaseObject):
    # no doc
    @classmethod
    def opnum(cls): # real signature unknown; restored from __doc__
        """ winspool.SyncUnRegisterForRemoteNotifications.opnum() -> 59 (0x3b) """
        pass
    ...
    in_phRpcHandle = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
