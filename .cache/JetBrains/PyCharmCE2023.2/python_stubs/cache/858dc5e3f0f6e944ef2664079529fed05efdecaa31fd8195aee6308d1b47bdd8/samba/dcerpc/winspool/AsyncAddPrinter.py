...
class AsyncAddPrinter(__talloc.BaseObject):
    # no doc
    @classmethod
    ...
    in_pClientInfo = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type spoolss_UserLevelCtr"""

    in_pDevModeContainer = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type spoolss_DevmodeContainer"""

    in_pName = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type uint16"""

    in_pPrinterContainer = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type spoolss_SetPrinterInfoCtr"""

    in_pSecurityContainer = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type sec_desc_buf"""

    out_pHandle = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
