...
TYPE_GSTRING = None # (!) real value is '<GType GString (94280156814912)>'

TYPE_INVALID = None # (!) real value is '<GType invalid (0)>'

_API = None # (!) real value is '<capsule object "gi._API" at 0x7f4211d3a9a0>'

_PyGObject_API = None # (!) real value is '<capsule object "gobject._PyGObject_API" at 0x7f4211d3a0d0>'

__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f4211d38610>'

__spec__ = None # (!) real value is "ModuleSpec(name='gi._gi', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f4211d38610>, origin='/usr/lib/python3/dist-packages/gi/_gi.cpython-310-x86_64-linux-gnu.so')"
