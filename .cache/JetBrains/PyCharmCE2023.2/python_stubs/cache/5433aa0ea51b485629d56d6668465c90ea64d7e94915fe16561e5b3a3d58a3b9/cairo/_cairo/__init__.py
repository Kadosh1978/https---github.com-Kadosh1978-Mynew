...
CAPI = None # (!) real value is '<capsule object "cairo.CAPI" at 0x7f4211d38db0>'
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f4211d2d7e0>'

__spec__ = None # (!) real value is "ModuleSpec(name='cairo._cairo', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f4211d2d7e0>, origin='/usr/lib/python3/dist-packages/cairo/_cairo.cpython-310-x86_64-linux-gnu.so')"
