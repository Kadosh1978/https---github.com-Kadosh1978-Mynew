...
class netr_LogonGetDomainInfo(__talloc.BaseObject):
    # no doc
    @classmethod
    def opnum(cls): # real signature unknown; restored from __doc__
        """ netlogon.netr_LogonGetDomainInfo.opnum() -> 29 (0x1d) """
        pass
    ...
    in_query = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type netr_WorkstationInfo"""
    ...
    """PIDL-generated element of base type netr_DomainInfo"""
