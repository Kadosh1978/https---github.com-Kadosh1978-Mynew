...
class netr_DatabaseRedo(__talloc.BaseObject):
    # no doc
    @classmethod
    def opnum(cls): # real signature unknown; restored from __doc__
        """ netlogon.netr_DatabaseRedo.opnum() -> 17 (0x11) """
        pass
    ...
    in_change_log_entry = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type netr_ChangeLogEntry"""

    in_change_log_entry_size = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
