...
class netr_LogonControl2Ex(__talloc.BaseObject):
    # no doc
    @classmethod
    def opnum(cls): # real signature unknown; restored from __doc__
        """ netlogon.netr_LogonControl2Ex.opnum() -> 18 (0x12) """
        pass
    ...
    """PIDL-generated element of base type netr_CONTROL_DATA_INFORMATION"""

    in_function_code = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type netr_LogonControlCode"""
    ...
    out_query = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type netr_CONTROL_QUERY_INFORMATION"""
