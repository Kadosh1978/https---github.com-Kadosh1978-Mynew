...
class netr_ServerAuthenticate3(__talloc.BaseObject):
    # no doc
    @classmethod
    def opnum(cls): # real signature unknown; restored from __doc__
        """ netlogon.netr_ServerAuthenticate3.opnum() -> 26 (0x1a) """
        pass
    ...
    in_credentials = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type netr_Credential"""

    in_negotiate_flags = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type netr_NegotiateFlags"""
    ...
    out_negotiate_flags = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type netr_NegotiateFlags"""

    out_return_credentials = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type netr_Credential"""

    out_rid = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
