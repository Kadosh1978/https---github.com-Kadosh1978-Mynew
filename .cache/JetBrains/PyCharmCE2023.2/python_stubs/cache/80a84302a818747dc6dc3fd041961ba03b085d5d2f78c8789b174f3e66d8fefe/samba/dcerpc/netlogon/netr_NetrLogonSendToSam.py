...
class netr_NetrLogonSendToSam(__talloc.BaseObject):
    # no doc
    @classmethod
    def opnum(cls): # real signature unknown; restored from __doc__
        """ netlogon.netr_NetrLogonSendToSam.opnum() -> 32 (0x20) """
        pass
    ...
    in_buffer_len = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    ...
    in_opaque_buffer = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
