...
class netr_LogonSamLogonWithFlags(__talloc.BaseObject):
    # no doc
    @classmethod
    def opnum(cls): # real signature unknown; restored from __doc__
        """ netlogon.netr_LogonSamLogonWithFlags.opnum() -> 45 (0x2d) """
        pass
    ...
    """PIDL-generated element of base type netr_LogonSamLogon_flags"""

    in_logon = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type netr_LogonLevel"""

    in_logon_level = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type netr_LogonInfoClass"""
    ...
    in_validation_level = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type uint16"""

    out_authoritative = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    ...
    out_validation = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type netr_Validation"""
