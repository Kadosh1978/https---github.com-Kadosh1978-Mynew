...
class netr_DsRAddressToSitenamesW(__talloc.BaseObject):
    # no doc
    @classmethod
    def opnum(cls): # real signature unknown; restored from __doc__
        """ netlogon.netr_DsRAddressToSitenamesW.opnum() -> 33 (0x21) """
        pass
    ...
    """PIDL-generated element of base type netr_DsRAddressToSitenamesWCtr"""
