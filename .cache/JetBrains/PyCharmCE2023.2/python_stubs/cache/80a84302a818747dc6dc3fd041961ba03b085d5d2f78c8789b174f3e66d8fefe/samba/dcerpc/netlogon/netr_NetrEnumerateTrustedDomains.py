...
class netr_NetrEnumerateTrustedDomains(__talloc.BaseObject):
    # no doc
    @classmethod
    def opnum(cls): # real signature unknown; restored from __doc__
        """ netlogon.netr_NetrEnumerateTrustedDomains.opnum() -> 19 (0x13) """
        pass
    ...
    out_trusted_domains_blob = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type netr_Blob"""
