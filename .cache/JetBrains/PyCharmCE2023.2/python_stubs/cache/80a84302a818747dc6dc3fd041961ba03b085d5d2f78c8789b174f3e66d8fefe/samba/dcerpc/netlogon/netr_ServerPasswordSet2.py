...
class netr_ServerPasswordSet2(__talloc.BaseObject):
    # no doc
    @classmethod
    def opnum(cls): # real signature unknown; restored from __doc__
        """ netlogon.netr_ServerPasswordSet2.opnum() -> 30 (0x1e) """
        pass
    ...
    in_new_password = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type netr_CryptPassword"""
