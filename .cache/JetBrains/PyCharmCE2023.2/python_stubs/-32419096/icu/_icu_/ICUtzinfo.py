...
class ICUtzinfo(__datetime.tzinfo):
    """ ICUtzinfo objects """
    ...
    @classmethod
    def getFloating(cls, *args, **kwargs): # real signature unknown
        pass
    ...
    @classmethod
    def getInstances(cls, *args, **kwargs): # real signature unknown
        pass
    ...
    @classmethod
    def _resetDefault(cls, *args, **kwargs): # real signature unknown
        pass
