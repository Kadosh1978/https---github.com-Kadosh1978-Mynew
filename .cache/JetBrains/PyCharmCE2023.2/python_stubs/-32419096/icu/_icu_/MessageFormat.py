...
class MessageFormat(__icu.Format):
    ...
    @classmethod
    def formatMessage(cls, *args, **kwargs): # real signature unknown
        pass

    def getFormatNames(self, *args, **kwargs): # real signature unknown
        pass
    ...
    def setFormats(self, *args, **kwargs): # real signature unknown
        pass
