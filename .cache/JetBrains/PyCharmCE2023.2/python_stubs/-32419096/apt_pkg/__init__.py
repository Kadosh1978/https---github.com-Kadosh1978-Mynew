...
config = None # (!) real value is '<apt_pkg.Configuration object at 0x7f4211d2db90>'
...
_C_API = None # (!) real value is '<capsule object "apt_pkg._C_API" at 0x7f4211d2d3b0>'

__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f4211d2db70>'

__spec__ = None # (!) real value is "ModuleSpec(name='apt_pkg', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f4211d2db70>, origin='/usr/lib/python3/dist-packages/apt_pkg.cpython-310-x86_64-linux-gnu.so')"
