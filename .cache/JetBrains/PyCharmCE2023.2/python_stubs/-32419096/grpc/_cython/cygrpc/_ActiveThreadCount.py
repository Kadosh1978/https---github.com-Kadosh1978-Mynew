...
class _ActiveThreadCount(object):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'grpc._cython.cygrpc', '__init__': <cyfunction _ActiveThreadCount.__init__ at 0x7f4211b1b850>, 'increment': <cyfunction _ActiveThreadCount.increment at 0x7f4211b1b920>, 'decrement': <cyfunction _ActiveThreadCount.decrement at 0x7f4211b1b9f0>, 'await_zero_threads': <cyfunction _ActiveThreadCount.await_zero_threads at 0x7f4211b1bac0>, '__dict__': <attribute '__dict__' of '_ActiveThreadCount' objects>, '__weakref__': <attribute '__weakref__' of '_ActiveThreadCount' objects>, '__doc__': None})"
