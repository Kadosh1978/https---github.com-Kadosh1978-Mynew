...
class _AsyncioSocket(object):
    # no doc
    def _async_connect(self, *args, **kwargs): # real signature unknown
        pass

    def _async_read(self, *args, **kwargs): # real signature unknown
        pass

    def _async_write(self, *args, **kwargs): # real signature unknown
        pass

    def _new_connection_callback(self, *args, **kwargs): # real signature unknown
        pass
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x7f4211a6b990>'
