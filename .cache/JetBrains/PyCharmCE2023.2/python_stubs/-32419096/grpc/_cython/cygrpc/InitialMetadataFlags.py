...
class InitialMetadataFlags(object):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'grpc._cython.cygrpc', 'used_mask': 500, 'wait_for_ready': 32, 'wait_for_ready_explicitly_set': 128, '__dict__': <attribute '__dict__' of 'InitialMetadataFlags' objects>, '__weakref__': <attribute '__weakref__' of 'InitialMetadataFlags' objects>, '__doc__': None})"
