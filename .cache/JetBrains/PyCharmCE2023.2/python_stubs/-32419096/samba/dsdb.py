# encoding: utf-8
# module samba.dsdb
# from /usr/lib/python3/dist-packages/samba/dsdb.cpython-310-x86_64-linux-gnu.so
# by generator 1.147
...
DSDB_CONTROL_BYPASS_PASSWORD_HASH_OID = '1.3.6.1.4.1.7165.4.3.12'

DSDB_CONTROL_DBCHECK = '1.3.6.1.4.1.7165.4.3.19'

DSDB_CONTROL_DBCHECK_FIX_DUPLICATE_LINKS = '1.3.6.1.4.1.7165.4.3.19.2'

DSDB_CONTROL_DBCHECK_FIX_LINK_DN_NAME = '1.3.6.1.4.1.7165.4.3.19.3'
DSDB_CONTROL_DBCHECK_FIX_LINK_DN_SID = '1.3.6.1.4.1.7165.4.3.19.4'

DSDB_CONTROL_DBCHECK_MODIFY_RO_REPLICA = '1.3.6.1.4.1.7165.4.3.19.1'

DSDB_CONTROL_INVALID_NOT_IMPLEMENTED = '1.3.6.1.4.1.7165.4.3.32'

DSDB_CONTROL_PERMIT_INTERDOMAIN_TRUST_UAC_OID = '1.3.6.1.4.1.7165.4.3.23'

DSDB_CONTROL_REPLMD_VANISH_LINKS = '1.3.6.1.4.1.7165.4.3.29'

DSDB_CONTROL_SKIP_DUPLICATES_CHECK_OID = '1.3.6.1.4.1.7165.4.3.28'
...
DS_DOMAIN_FUNCTION_2012 = 5

DS_DOMAIN_FUNCTION_2012_R2 = 6

DS_DOMAIN_FUNCTION_2016 = 7
...
def user_account_control_flag_bit_to_string(bit): # real signature unknown; restored from __doc__
    """ user_account_control_flag_bit_to_string(bit) -> string name """
    return ""
...
def _dns_delete_tombstones(*args, **kwargs): # real signature unknown
    pass

def _dsdb_allocate_rid(samdb): # real signature unknown; restored from __doc__
    """ _dsdb_allocate_rid(samdb) -> RID """
    pass
...
def _dsdb_create_own_rid_set(samdb): # real signature unknown; restored from __doc__
    """ _dsdb_create_own_rid_set(samdb) -> None """
    pass

def _dsdb_DsReplicaAttribute(*args, **kwargs): # real signature unknown
    pass

def _dsdb_garbage_collect_tombstones(*args, **kwargs): # real signature unknown
    """ _dsdb_kcc_check_deleted(samdb, [dn], current_time, tombstone_lifetime) -> (num_objects_expunged, num_links_expunged) """
    pass
...
def _dsdb_load_udv_v2(*args, **kwargs): # real signature unknown
    pass
...
def _scavenge_dns_records(*args, **kwargs): # real signature unknown
    pass
...
__spec__ = None # (!) real value is "ModuleSpec(name='samba.dsdb', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f4211d2d570>, origin='/usr/lib/python3/dist-packages/samba/dsdb.cpython-310-x86_64-linux-gnu.so')"
