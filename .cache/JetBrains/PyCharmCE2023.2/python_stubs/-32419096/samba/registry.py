...
# from /usr/lib/python3/dist-packages/samba/registry.cpython-310-x86_64-linux-gnu.so
# by generator 1.147
""" Registry """
...
class HiveKey(__talloc.BaseObject):
    # no doc
...
class Registry(__talloc.BaseObject):
    # no doc
...
class RegistryKey(__talloc.BaseObject):
    # no doc
    def __init__(self, *args, **kwargs): # real signature unknown
        pass
...
__spec__ = None # (!) real value is "ModuleSpec(name='samba.registry', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f4211d2d540>, origin='/usr/lib/python3/dist-packages/samba/registry.cpython-310-x86_64-linux-gnu.so')"
