...
LSA_TRUST_ATTRIBUTE_CROSS_ORGANIZATION_ENABLE_TGT_DELEGATION = 2048

LSA_TRUST_ATTRIBUTE_CROSS_ORGANIZATION_NO_TGT_DELEGATION = 512

LSA_TRUST_ATTRIBUTE_FOREST_TRANSITIVE = 8

LSA_TRUST_ATTRIBUTE_NON_TRANSITIVE = 1

LSA_TRUST_ATTRIBUTE_PIM_TRUST = 1024
...
from .lsarpc_abstract_syntax import lsarpc_abstract_syntax
from .abstract_syntax import abstract_syntax
from .AddAccountRights import AddAccountRights
from .AddPrivilegesToAccount import AddPrivilegesToAccount
...
from .CloseTrustedDomainEx import CloseTrustedDomainEx
from .CreateAccount import CreateAccount
from .CreateSecret import CreateSecret
from .CreateTrustedDomain import CreateTrustedDomain
from .CreateTrustedDomainEx import CreateTrustedDomainEx
from .CreateTrustedDomainEx2 import CreateTrustedDomainEx2
...
from .DeleteTrustedDomain import DeleteTrustedDomain
...
from .DomainInformationPolicy import DomainInformationPolicy
from .DomainList import DomainList
from .DomainListEx import DomainListEx
from .EnumAccountRights import EnumAccountRights
from .EnumAccounts import EnumAccounts
from .EnumAccountsWithUserRight import EnumAccountsWithUserRight
from .EnumPrivs import EnumPrivs
from .EnumPrivsAccount import EnumPrivsAccount
from .EnumTrustDom import EnumTrustDom
from .EnumTrustedDomainsEx import EnumTrustedDomainsEx
...
from .GetSystemAccessAccount import GetSystemAccessAccount
from .GetUserName import GetUserName
from .LookupNames import LookupNames
from .LookupNames2 import LookupNames2
from .LookupNames3 import LookupNames3
from .LookupNames4 import LookupNames4
from .LookupPrivDisplayName import LookupPrivDisplayName
from .LookupPrivName import LookupPrivName
from .LookupPrivValue import LookupPrivValue
from .LookupSids import LookupSids
from .LookupSids2 import LookupSids2
from .LookupSids3 import LookupSids3
from .lsarpc import lsarpc
from .lsaRQueryForestTrustInformation import lsaRQueryForestTrustInformation
from .lsaRSetForestTrustInformation import lsaRSetForestTrustInformation
...
from .OpenPolicy import OpenPolicy
from .OpenPolicy2 import OpenPolicy2
from .OpenSecret import OpenSecret
from .OpenTrustedDomain import OpenTrustedDomain
from .OpenTrustedDomainByName import OpenTrustedDomainByName
from .PDAccountInfo import PDAccountInfo
from .PolicyInformation import PolicyInformation
...
from .QueryDomainInformationPolicy import QueryDomainInformationPolicy
from .QueryInfoPolicy import QueryInfoPolicy
from .QueryInfoPolicy2 import QueryInfoPolicy2
from .QuerySecret import QuerySecret
from .QuerySecurity import QuerySecurity
from .QueryTrustedDomainInfo import QueryTrustedDomainInfo
from .QueryTrustedDomainInfoByName import QueryTrustedDomainInfoByName
from .QueryTrustedDomainInfoBySid import QueryTrustedDomainInfoBySid
from .RefDomainList import RefDomainList
from .RemoveAccountRights import RemoveAccountRights
from .RemovePrivilegesFromAccount import RemovePrivilegesFromAccount
from .ReplicaSourceInfo import ReplicaSourceInfo
from .RetrievePrivateData import RetrievePrivateData
from .RightAttribute import RightAttribute
from .RightSet import RightSet
from .ServerRole import ServerRole
from .SetDomainInformationPolicy import SetDomainInformationPolicy
from .SetInfoPolicy import SetInfoPolicy
from .SetInfoPolicy2 import SetInfoPolicy2
from .SetInformationTrustedDomain import SetInformationTrustedDomain
from .SetSecObj import SetSecObj
from .SetSecret import SetSecret
from .SetSystemAccessAccount import SetSystemAccessAccount
from .SetTrustedDomainInfo import SetTrustedDomainInfo
from .SetTrustedDomainInfoByName import SetTrustedDomainInfoByName
from .SidArray import SidArray
from .SidPtr import SidPtr
from .StorePrivateData import StorePrivateData
...
from .TrustedDomainInfo import TrustedDomainInfo
# variables with complex values

__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f4211d2db40>'

__spec__ = None # (!) real value is "ModuleSpec(name='samba.dcerpc.lsa', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f4211d2db40>, origin='/usr/lib/python3/dist-packages/samba/dcerpc/lsa.cpython-310-x86_64-linux-gnu.so')"
