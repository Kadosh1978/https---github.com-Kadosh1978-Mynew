...
class RemoveAccountRights(__talloc.BaseObject):
    # no doc
    @classmethod
    ...
    in_rights = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type lsa_RightSet"""
