...
class RetrievePrivateData(__talloc.BaseObject):
    # no doc
    @classmethod
    ...
    in_val = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type lsa_DATA_BUF"""

    out_val = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type lsa_DATA_BUF"""
