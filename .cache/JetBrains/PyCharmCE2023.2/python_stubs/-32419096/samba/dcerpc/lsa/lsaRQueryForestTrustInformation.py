...
class lsaRQueryForestTrustInformation(__talloc.BaseObject):
    # no doc
    @classmethod
    ...
    out_forest_trust_info = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
