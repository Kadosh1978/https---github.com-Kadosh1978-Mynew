...
class GetSystemAccessAccount(__talloc.BaseObject):
    # no doc
    @classmethod
    ...
    out_access_mask = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type lsa_AccountAccessMask"""
