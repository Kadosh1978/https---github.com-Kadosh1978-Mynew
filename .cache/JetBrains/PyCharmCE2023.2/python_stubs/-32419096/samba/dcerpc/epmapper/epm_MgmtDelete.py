...
class epm_MgmtDelete(__talloc.BaseObject):
    # no doc
    @classmethod
    ...
    in_object_speced = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type uint32"""

    in_tower = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
