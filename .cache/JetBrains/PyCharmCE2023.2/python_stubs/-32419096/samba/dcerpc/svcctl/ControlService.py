...
class ControlService(__talloc.BaseObject):
    # no doc
    @classmethod
    ...
    in_control = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type SERVICE_CONTROL"""
    ...
    """PIDL-generated element of base type SERVICE_STATUS"""
