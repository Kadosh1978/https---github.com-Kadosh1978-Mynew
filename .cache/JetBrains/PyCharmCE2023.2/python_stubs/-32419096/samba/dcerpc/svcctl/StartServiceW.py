...
class StartServiceW(__talloc.BaseObject):
    # no doc
    @classmethod
    ...
    in_Arguments = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type svcctl_ArgumentString"""
    ...
    in_NumArgs = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
