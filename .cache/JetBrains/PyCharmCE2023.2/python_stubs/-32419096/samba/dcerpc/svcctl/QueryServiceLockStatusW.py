...
class QueryServiceLockStatusW(__talloc.BaseObject):
    # no doc
    @classmethod
    ...
    out_lock_status = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type SERVICE_LOCK_STATUS"""
