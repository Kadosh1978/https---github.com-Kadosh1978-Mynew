...
class EnumDependentServicesA(__talloc.BaseObject):
    # no doc
    @classmethod
    ...
    in_service = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    ...
    out_services_returned = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type uint32"""

    out_service_status = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type ENUM_SERVICE_STATUSA"""
