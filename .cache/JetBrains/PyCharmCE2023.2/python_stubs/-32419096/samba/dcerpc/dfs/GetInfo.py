...
class GetInfo(__talloc.BaseObject):
    # no doc
    @classmethod
    ...
    in_dfs_entry_path = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    ...
    in_sharename = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type uint16"""

    out_info = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type dfs_Info"""
