...
class NetrMessageBufferSend(__talloc.BaseObject):
    # no doc
    @classmethod
    ...
    in_message_buffer = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type uint8"""

    in_message_name = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type uint16"""

    in_message_sender_name = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type uint16"""

    in_message_size = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
