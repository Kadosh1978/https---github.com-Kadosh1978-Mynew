...
class NetrAddAlternateComputerName(__talloc.BaseObject):
    # no doc
    @classmethod
    def opnum(cls): # real signature unknown; restored from __doc__
        """ wkssvc.NetrAddAlternateComputerName.opnum() -> 27 (0x1b) """
        pass
    ...
    in_NewAlternateMachineName = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type uint16"""
