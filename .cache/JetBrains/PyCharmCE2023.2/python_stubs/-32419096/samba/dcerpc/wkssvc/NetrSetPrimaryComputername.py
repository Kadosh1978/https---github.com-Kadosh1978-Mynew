...
class NetrSetPrimaryComputername(__talloc.BaseObject):
    # no doc
    @classmethod
    def opnum(cls): # real signature unknown; restored from __doc__
        """ wkssvc.NetrSetPrimaryComputername.opnum() -> 29 (0x1d) """
        pass
    ...
    in_primary_name = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type uint16"""
