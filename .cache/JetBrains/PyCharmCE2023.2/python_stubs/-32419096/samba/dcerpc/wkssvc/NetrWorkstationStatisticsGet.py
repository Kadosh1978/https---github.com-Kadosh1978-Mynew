...
class NetrWorkstationStatisticsGet(__talloc.BaseObject):
    # no doc
    @classmethod
    ...
    in_unknown4 = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type uint32"""

    out_info = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type wkssvc_NetrWorkstationStatistics"""
