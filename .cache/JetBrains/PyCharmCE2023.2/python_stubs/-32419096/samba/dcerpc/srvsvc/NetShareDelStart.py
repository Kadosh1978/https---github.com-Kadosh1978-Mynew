...
class NetShareDelStart(__talloc.BaseObject):
    # no doc
    @classmethod
    def opnum(cls): # real signature unknown; restored from __doc__
        """ srvsvc.NetShareDelStart.opnum() -> 37 (0x25) """
        pass
    ...
    in_reserved = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    ...
    out_hnd = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
