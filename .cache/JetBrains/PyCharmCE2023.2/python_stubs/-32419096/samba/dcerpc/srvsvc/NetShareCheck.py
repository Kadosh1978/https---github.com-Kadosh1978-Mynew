...
class NetShareCheck(__talloc.BaseObject):
    # no doc
    @classmethod
    def opnum(cls): # real signature unknown; restored from __doc__
        """ srvsvc.NetShareCheck.opnum() -> 20 (0x14) """
        pass
    ...
    in_device_name = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
