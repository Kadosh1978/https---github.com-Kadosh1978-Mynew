...
class NetFileGetInfo(__talloc.BaseObject):
    # no doc
    @classmethod
    def opnum(cls): # real signature unknown; restored from __doc__
        """ srvsvc.NetFileGetInfo.opnum() -> 10 (0x0a) """
        pass
    ...
    in_fid = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    ...
    """PIDL-generated element of base type srvsvc_NetFileInfo"""
