...
class OemChangePasswordUser2(__talloc.BaseObject):
    # no doc
    @classmethod
    def opnum(cls): # real signature unknown; restored from __doc__
        """ samr.OemChangePasswordUser2.opnum() -> 54 (0x36) """
        pass
    ...
    """PIDL-generated element of base type lsa_AsciiString"""

    in_hash = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
