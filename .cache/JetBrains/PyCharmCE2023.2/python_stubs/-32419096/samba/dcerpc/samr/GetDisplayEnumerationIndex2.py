...
class GetDisplayEnumerationIndex2(__talloc.BaseObject):
    # no doc
    @classmethod
    def opnum(cls): # real signature unknown; restored from __doc__
        """ samr.GetDisplayEnumerationIndex2.opnum() -> 49 (0x31) """
        pass
    ...
    out_idx = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
