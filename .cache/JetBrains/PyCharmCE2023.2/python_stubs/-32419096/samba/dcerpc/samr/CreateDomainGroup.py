...
class CreateDomainGroup(__talloc.BaseObject):
    # no doc
    @classmethod
    ...
    """PIDL-generated element of base type samr_GroupAccessMask"""
    ...
    out_group_handle = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type policy_handle"""
