...
class CreateDomAlias(__talloc.BaseObject):
    # no doc
    @classmethod
    ...
    """PIDL-generated element of base type samr_AliasAccessMask"""

    in_alias_name = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    ...
    out_alias_handle = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type policy_handle"""
