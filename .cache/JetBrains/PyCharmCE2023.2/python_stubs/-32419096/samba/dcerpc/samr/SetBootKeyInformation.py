...
class SetBootKeyInformation(__talloc.BaseObject):
    # no doc
    @classmethod
    def opnum(cls): # real signature unknown; restored from __doc__
        """ samr.SetBootKeyInformation.opnum() -> 59 (0x3b) """
        pass
    ...
    in_connect_handle = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    ...
    in_unknown3 = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type uint32"""
