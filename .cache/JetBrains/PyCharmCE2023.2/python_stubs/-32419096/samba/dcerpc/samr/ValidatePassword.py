...
class ValidatePassword(__talloc.BaseObject):
    # no doc
    @classmethod
    def opnum(cls): # real signature unknown; restored from __doc__
        """ samr.ValidatePassword.opnum() -> 67 (0x43) """
        pass
    ...
    """PIDL-generated element of base type samr_ValidatePasswordLevel"""

    in_req = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type samr_ValidatePasswordReq"""

    out_rep = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type samr_ValidatePasswordRep"""
