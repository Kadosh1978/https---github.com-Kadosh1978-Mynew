...
class CreateUser2(__talloc.BaseObject):
    # no doc
    @classmethod
    def opnum(cls): # real signature unknown; restored from __doc__
        """ samr.CreateUser2.opnum() -> 50 (0x32) """
        pass
    ...
    """PIDL-generated element of base type samr_UserAccessMask"""
    ...
    in_acct_flags = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    ...
    out_access_granted = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type uint32"""

    out_rid = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type uint32"""

    out_user_handle = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type policy_handle"""
