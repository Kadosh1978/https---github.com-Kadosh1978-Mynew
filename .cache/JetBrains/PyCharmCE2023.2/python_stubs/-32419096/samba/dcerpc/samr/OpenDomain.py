...
class OpenDomain(__talloc.BaseObject):
    # no doc
    @classmethod
    ...
    """PIDL-generated element of base type samr_DomainAccessMask"""
    ...
    out_domain_handle = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type policy_handle"""
