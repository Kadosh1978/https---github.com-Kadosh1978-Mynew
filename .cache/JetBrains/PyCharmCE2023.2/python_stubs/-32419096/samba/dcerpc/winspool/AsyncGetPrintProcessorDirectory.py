...
class AsyncGetPrintProcessorDirectory(__talloc.BaseObject):
    # no doc
    @classmethod
    def opnum(cls): # real signature unknown; restored from __doc__
        """ winspool.AsyncGetPrintProcessorDirectory.opnum() -> 46 (0x2e) """
        pass
    ...
    in_pPrintProcessorDirectory = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    ...
    out_pPrintProcessorDirectory = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type uint8"""
