...
class AsyncSetJobNamedProperty(__talloc.BaseObject):
    # no doc
    @classmethod
    def opnum(cls): # real signature unknown; restored from __doc__
        """ winspool.AsyncSetJobNamedProperty.opnum() -> 71 (0x47) """
        pass
    ...
    in_pProperty = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
