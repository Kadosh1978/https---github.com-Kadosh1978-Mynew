...
class AsyncEnumMonitors(__talloc.BaseObject):
    # no doc
    @classmethod
    def opnum(cls): # real signature unknown; restored from __doc__
        """ winspool.AsyncEnumMonitors.opnum() -> 48 (0x30) """
        pass
    ...
    in_pMonitor = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    ...
    out_pMonitor = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type uint8"""
