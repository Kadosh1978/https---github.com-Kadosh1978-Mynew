...
class AsyncInstallPrinterDriverFromPackage(__talloc.BaseObject):
    # no doc
    @classmethod
    def opnum(cls): # real signature unknown; restored from __doc__
        """ winspool.AsyncInstallPrinterDriverFromPackage.opnum() -> 62 (0x3e) """
        pass
    ...
    """PIDL-generated element of base type winspool_InstallPrinterDriverFromPackageFlags"""

    in_pszDriverName = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
