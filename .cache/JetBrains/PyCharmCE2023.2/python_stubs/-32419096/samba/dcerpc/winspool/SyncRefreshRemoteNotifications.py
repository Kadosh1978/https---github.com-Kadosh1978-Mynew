...
class SyncRefreshRemoteNotifications(__talloc.BaseObject):
    # no doc
    @classmethod
    def opnum(cls): # real signature unknown; restored from __doc__
        """ winspool.SyncRefreshRemoteNotifications.opnum() -> 60 (0x3c) """
        pass
    ...
    in_hRpcHandle = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    ...
    out_ppNotifyData = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type winspool_PrintPropertiesCollection"""
