...
class AsyncAddPrinterDriver(__talloc.BaseObject):
    # no doc
    @classmethod
    ...
    in_dwFileCopyFlags = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type uint32"""

    in_pDriverContainer = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type spoolss_AddDriverInfoCtr"""
