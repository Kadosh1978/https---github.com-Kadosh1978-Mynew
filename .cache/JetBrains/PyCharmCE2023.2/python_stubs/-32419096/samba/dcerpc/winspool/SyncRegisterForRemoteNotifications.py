...
class SyncRegisterForRemoteNotifications(__talloc.BaseObject):
    # no doc
    @classmethod
    def opnum(cls): # real signature unknown; restored from __doc__
        """ winspool.SyncRegisterForRemoteNotifications.opnum() -> 58 (0x3a) """
        pass
    ...
    in_pNotifyFilter = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type winspool_PrintPropertiesCollection"""

    out_phRpcHandle = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type policy_handle"""
