...
class AsyncStartDocPrinter(__talloc.BaseObject):
    # no doc
    @classmethod
    ...
    in_pDocInfoContainer = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type spoolss_DocumentInfoCtr"""

    out_pJobId = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
