...
class AsyncEnumPrinterDataEx(__talloc.BaseObject):
    # no doc
    @classmethod
    ...
    in_cbEnumValues = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    ...
    out_pcbEnumValues = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type uint32"""

    out_pEnumValues = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type uint8"""

    out_pnEnumValues = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type uint32"""
