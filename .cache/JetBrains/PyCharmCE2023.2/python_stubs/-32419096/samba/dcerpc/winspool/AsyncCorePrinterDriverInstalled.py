...
class AsyncCorePrinterDriverInstalled(__talloc.BaseObject):
    # no doc
    @classmethod
    def opnum(cls): # real signature unknown; restored from __doc__
        """ winspool.AsyncCorePrinterDriverInstalled.opnum() -> 65 (0x41) """
        pass
    ...
    in_CoreDriverGUID = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type GUID"""

    in_dwlDriverVersion = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type hyper"""

    in_ftDriverDate = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    ...
    out_pbDriverInstalled = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
