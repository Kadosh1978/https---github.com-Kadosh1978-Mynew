...
class AsyncDeletePrinterDriverEx(__talloc.BaseObject):
    # no doc
    @classmethod
    def opnum(cls): # real signature unknown; restored from __doc__
        """ winspool.AsyncDeletePrinterDriverEx.opnum() -> 43 (0x2b) """
        pass
    ...
    in_dwDeleteFlag = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type uint32"""

    in_dwVersionNum = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type uint32"""

    in_pDriverName = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
