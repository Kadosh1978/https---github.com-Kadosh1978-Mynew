...
class AsyncEnumPrinterKey(__talloc.BaseObject):
    # no doc
    @classmethod
    ...
    in_cbSubkey = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    ...
    out_pcbSubkey = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type uint32"""

    out_pSubkey = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type uint16"""
