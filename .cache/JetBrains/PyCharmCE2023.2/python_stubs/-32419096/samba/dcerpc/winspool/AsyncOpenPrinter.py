...
class AsyncOpenPrinter(__talloc.BaseObject):
    # no doc
    @classmethod
    ...
    in_AccessRequired = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    ...
    in_pDatatype = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    ...
    in_pPrinterName = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type uint16"""
