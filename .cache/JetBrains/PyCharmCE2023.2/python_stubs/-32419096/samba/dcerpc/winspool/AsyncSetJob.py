...
class AsyncSetJob(__talloc.BaseObject):
    # no doc
    @classmethod
    ...
    in_pJobContainer = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type spoolss_JobInfoContainer"""
