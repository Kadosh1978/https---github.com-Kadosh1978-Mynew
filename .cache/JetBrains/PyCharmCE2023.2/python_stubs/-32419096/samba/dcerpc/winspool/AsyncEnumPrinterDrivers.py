...
class AsyncEnumPrinterDrivers(__talloc.BaseObject):
    # no doc
    @classmethod
    ...
    in_pDrivers = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    ...
    out_pDrivers = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type uint8"""
