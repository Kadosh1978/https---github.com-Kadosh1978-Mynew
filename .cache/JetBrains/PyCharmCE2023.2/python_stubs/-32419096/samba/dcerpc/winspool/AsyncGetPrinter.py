...
class AsyncGetPrinter(__talloc.BaseObject):
    # no doc
    @classmethod
    ...
    in_pPrinter = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    ...
    out_pPrinter = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type uint8"""
