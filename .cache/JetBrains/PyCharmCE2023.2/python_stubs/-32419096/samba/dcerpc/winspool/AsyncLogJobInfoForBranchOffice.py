...
class AsyncLogJobInfoForBranchOffice(__talloc.BaseObject):
    # no doc
    @classmethod
    def opnum(cls): # real signature unknown; restored from __doc__
        """ winspool.AsyncLogJobInfoForBranchOffice.opnum() -> 74 (0x4a) """
        pass
    ...
    in_pBranchOfficeJobDataContainer = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type spoolss_BranchOfficeJobDataContainer"""
