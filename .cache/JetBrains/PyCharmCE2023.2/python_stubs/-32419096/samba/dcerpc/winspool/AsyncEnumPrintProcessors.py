...
class AsyncEnumPrintProcessors(__talloc.BaseObject):
    # no doc
    @classmethod
    def opnum(cls): # real signature unknown; restored from __doc__
        """ winspool.AsyncEnumPrintProcessors.opnum() -> 45 (0x2d) """
        pass
    ...
    in_pPrintProcessorInfo = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    ...
    out_pPrintProcessorInfo = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type uint8"""
