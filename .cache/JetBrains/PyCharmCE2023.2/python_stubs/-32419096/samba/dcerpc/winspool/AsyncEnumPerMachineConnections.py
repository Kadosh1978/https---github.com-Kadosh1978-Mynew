...
class AsyncEnumPerMachineConnections(__talloc.BaseObject):
    # no doc
    @classmethod
    def opnum(cls): # real signature unknown; restored from __doc__
        """ winspool.AsyncEnumPerMachineConnections.opnum() -> 57 (0x39) """
        pass
    ...
    in_pPrinterEnum = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type uint8"""

    in_pServer = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    ...
    out_pPrinterEnum = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type uint8"""
