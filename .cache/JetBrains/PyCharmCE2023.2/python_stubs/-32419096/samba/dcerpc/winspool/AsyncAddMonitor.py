...
class AsyncAddMonitor(__talloc.BaseObject):
    # no doc
    @classmethod
    def opnum(cls): # real signature unknown; restored from __doc__
        """ winspool.AsyncAddMonitor.opnum() -> 51 (0x33) """
        pass
    ...
    in_pMonitorContainer = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type spoolss_MonitorContainer"""
