...
class ExtendedErrorComputerName(__talloc.BaseObject):
    # no doc
    ...
    """PIDL-generated element of base type ExtendedErrorComputerNameU"""

    present = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type ExtendedErrorComputerNamePresent"""
