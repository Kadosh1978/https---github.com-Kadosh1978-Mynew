...
class package_PrimaryUserPasswordBlob(__talloc.BaseObject):
    # no doc
    ...
    current_nt_hash = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    ...
    """PIDL-generated element of base type package_PrimaryUserPasswordValue"""
