...
class DnssrvQuery2(__talloc.BaseObject):
    # no doc
    @classmethod
    def opnum(cls): # real signature unknown; restored from __doc__
        """ dnsserver.DnssrvQuery2.opnum() -> 6 (0x06) """
        pass
    ...
    out_pdwTypeId = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type DNS_RPC_TYPEID"""

    out_ppData = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
