...
class DnssrvUpdateRecord2(__talloc.BaseObject):
    # no doc
    @classmethod
    def opnum(cls): # real signature unknown; restored from __doc__
        """ dnsserver.DnssrvUpdateRecord2.opnum() -> 9 (0x09) """
        pass
    ...
    in_pAddRecord = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type DNS_RPC_RECORD_BUF"""

    in_pDeleteRecord = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type DNS_RPC_RECORD_BUF"""
