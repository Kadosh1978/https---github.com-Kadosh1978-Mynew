...
class DnssrvComplexOperation2(__talloc.BaseObject):
    # no doc
    @classmethod
    def opnum(cls): # real signature unknown; restored from __doc__
        """ dnsserver.DnssrvComplexOperation2.opnum() -> 7 (0x07) """
        pass
    ...
    in_dwClientVersion = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type DNS_RPC_CLIENT_VERSION"""

    in_dwSettingFlags = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type uint32"""

    in_dwTypeIn = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type DNS_RPC_TYPEID"""

    in_pDataIn = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    ...
    out_pdwTypeOut = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type DNS_RPC_TYPEID"""

    out_ppDataOut = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type DNSSRV_RPC_UNION"""
