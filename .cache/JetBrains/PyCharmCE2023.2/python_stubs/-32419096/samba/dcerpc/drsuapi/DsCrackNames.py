...
class DsCrackNames(__talloc.BaseObject):
    # no doc
    @classmethod
    def opnum(cls): # real signature unknown; restored from __doc__
        """ drsuapi.DsCrackNames.opnum() -> 12 (0x0c) """
        pass
    ...
    """PIDL-generated element of base type drsuapi_DsNameRequest"""

    out_ctr = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type drsuapi_DsNameCtr"""
