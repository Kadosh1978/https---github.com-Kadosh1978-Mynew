...
class DsReplicaGetInfo(__talloc.BaseObject):
    # no doc
    @classmethod
    def opnum(cls): # real signature unknown; restored from __doc__
        """ drsuapi.DsReplicaGetInfo.opnum() -> 19 (0x13) """
        pass
    ...
    """PIDL-generated element of base type drsuapi_DsReplicaGetInfoLevel"""

    in_req = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type drsuapi_DsReplicaGetInfoRequest"""

    out_info = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type drsuapi_DsReplicaInfo"""

    out_info_type = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
