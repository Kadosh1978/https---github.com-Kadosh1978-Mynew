...
class DsGetMemberships(__talloc.BaseObject):
    # no doc
    @classmethod
    def opnum(cls): # real signature unknown; restored from __doc__
        """ drsuapi.DsGetMemberships.opnum() -> 9 (0x09) """
        pass
    ...
    """PIDL-generated element of base type drsuapi_DsGetMembershipsRequest"""

    out_ctr = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type drsuapi_DsGetMembershipsCtr"""
