...
class DsWriteAccountSpn(__talloc.BaseObject):
    # no doc
    @classmethod
    def opnum(cls): # real signature unknown; restored from __doc__
        """ drsuapi.DsWriteAccountSpn.opnum() -> 13 (0x0d) """
        pass
    ...
    in_bind_handle = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    ...
    in_req = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type drsuapi_DsWriteAccountSpnRequest"""

    out_level_out = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type uint32"""

    out_res = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type drsuapi_DsWriteAccountSpnResult"""
