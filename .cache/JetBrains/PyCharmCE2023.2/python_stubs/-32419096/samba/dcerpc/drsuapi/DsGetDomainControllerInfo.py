...
class DsGetDomainControllerInfo(__talloc.BaseObject):
    # no doc
    @classmethod
    def opnum(cls): # real signature unknown; restored from __doc__
        """ drsuapi.DsGetDomainControllerInfo.opnum() -> 16 (0x10) """
        pass
    ...
    """PIDL-generated element of base type drsuapi_DsGetDCInfoRequest"""

    out_ctr = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type drsuapi_DsGetDCInfoCtr"""

    out_level_out = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type drsuapi_DsGetDCInfoCtrLevels"""
