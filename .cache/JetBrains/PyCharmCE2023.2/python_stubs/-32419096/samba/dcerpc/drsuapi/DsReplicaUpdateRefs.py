...
class DsReplicaUpdateRefs(__talloc.BaseObject):
    # no doc
    @classmethod
    def opnum(cls): # real signature unknown; restored from __doc__
        """ drsuapi.DsReplicaUpdateRefs.opnum() -> 4 (0x04) """
        pass
    ...
    """PIDL-generated element of base type drsuapi_DsReplicaUpdateRefsRequest"""
