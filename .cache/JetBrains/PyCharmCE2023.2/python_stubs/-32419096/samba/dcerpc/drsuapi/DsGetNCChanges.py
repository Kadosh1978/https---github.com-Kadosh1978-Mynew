...
class DsGetNCChanges(__talloc.BaseObject):
    # no doc
    @classmethod
    def opnum(cls): # real signature unknown; restored from __doc__
        """ drsuapi.DsGetNCChanges.opnum() -> 3 (0x03) """
        pass
    ...
    """PIDL-generated element of base type drsuapi_DsGetNCChangesRequest"""

    out_ctr = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type drsuapi_DsGetNCChangesCtr"""
