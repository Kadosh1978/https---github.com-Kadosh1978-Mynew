...
class ReplaceKey(__talloc.BaseObject):
    # no doc
    @classmethod
    ...
    in_new_file = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type winreg_String"""

    in_old_file = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type winreg_String"""

    in_subkey = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type winreg_String"""
