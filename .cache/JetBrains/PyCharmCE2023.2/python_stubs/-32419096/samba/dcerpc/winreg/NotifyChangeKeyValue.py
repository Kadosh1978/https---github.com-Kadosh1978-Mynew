...
class NotifyChangeKeyValue(__talloc.BaseObject):
    # no doc
    @classmethod
    ...
    in_notify_filter = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type winreg_NotifyChangeType"""

    in_string1 = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type winreg_String"""

    in_string2 = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type winreg_String"""
    ...
    in_watch_subtree = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
