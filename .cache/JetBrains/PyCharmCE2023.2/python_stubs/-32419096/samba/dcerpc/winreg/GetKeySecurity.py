...
class GetKeySecurity(__talloc.BaseObject):
    # no doc
    @classmethod
    ...
    in_sd = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type KeySecurityData"""

    in_sec_info = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type security_secinfo"""

    out_sd = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type KeySecurityData"""
