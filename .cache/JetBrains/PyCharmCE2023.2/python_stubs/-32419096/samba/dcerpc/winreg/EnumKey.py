...
class EnumKey(__talloc.BaseObject):
    # no doc
    @classmethod
    ...
    """PIDL-generated element of base type winreg_StringBuf"""

    in_last_changed_time = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    ...
    out_keyclass = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type winreg_StringBuf"""
