...
from .nbt_abstract_syntax import nbt_abstract_syntax
...
from .netlogon_request import netlogon_request
from .netlogon_response2 import netlogon_response2
from .netlogon_response_from_pdc import netlogon_response_from_pdc
from .netlogon_samlogon_response import netlogon_samlogon_response
from .netlogon_samlogon_response_union import netlogon_samlogon_response_union
...
__spec__ = None # (!) real value is "ModuleSpec(name='samba.dcerpc.nbt', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f4211d2db40>, origin='/usr/lib/python3/dist-packages/samba/dcerpc/nbt.cpython-310-x86_64-linux-gnu.so')"
