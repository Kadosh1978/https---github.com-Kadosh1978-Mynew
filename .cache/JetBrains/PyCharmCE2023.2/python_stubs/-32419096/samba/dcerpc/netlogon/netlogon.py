...
class netlogon(__dcerpc.ClientConnection):
    ...
    def netr_NetrLogonSendToSam(self, server_name, computer_name, credential, opaque_buffer): # real signature unknown; restored from __doc__
        """ S.netr_NetrLogonSendToSam(server_name, computer_name, credential, opaque_buffer) -> return_authenticator """
        pass
