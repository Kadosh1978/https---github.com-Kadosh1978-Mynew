...
class netr_DsrEnumerateDomainTrusts(__talloc.BaseObject):
    # no doc
    @classmethod
    def opnum(cls): # real signature unknown; restored from __doc__
        """ netlogon.netr_DsrEnumerateDomainTrusts.opnum() -> 40 (0x28) """
        pass
    ...
    in_trust_flags = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type netr_TrustFlags"""

    out_trusts = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type netr_DomainTrustList"""
