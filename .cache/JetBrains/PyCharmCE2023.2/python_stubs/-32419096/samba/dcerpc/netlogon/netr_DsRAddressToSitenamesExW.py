...
class netr_DsRAddressToSitenamesExW(__talloc.BaseObject):
    # no doc
    @classmethod
    def opnum(cls): # real signature unknown; restored from __doc__
        """ netlogon.netr_DsRAddressToSitenamesExW.opnum() -> 37 (0x25) """
        pass
    ...
    in_addresses = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type netr_DsRAddress"""
    ...
    """PIDL-generated element of base type netr_DsRAddressToSitenamesExWCtr"""
