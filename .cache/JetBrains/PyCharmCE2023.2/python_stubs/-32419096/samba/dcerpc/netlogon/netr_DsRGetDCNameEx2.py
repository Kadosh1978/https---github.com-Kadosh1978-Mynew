...
class netr_DsRGetDCNameEx2(__talloc.BaseObject):
    # no doc
    @classmethod
    def opnum(cls): # real signature unknown; restored from __doc__
        """ netlogon.netr_DsRGetDCNameEx2.opnum() -> 34 (0x22) """
        pass
    ...
    in_client_account = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type uint16"""

    in_domain_guid = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    ...
    """PIDL-generated element of base type netr_DsRGetDCName_flags"""

    in_mask = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    ...
    """PIDL-generated element of base type netr_DsRGetDCNameInfo"""
