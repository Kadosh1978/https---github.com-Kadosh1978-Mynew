...
class netr_NetrEnumerateTrustedDomainsEx(__talloc.BaseObject):
    # no doc
    @classmethod
    def opnum(cls): # real signature unknown; restored from __doc__
        """ netlogon.netr_NetrEnumerateTrustedDomainsEx.opnum() -> 36 (0x24) """
        pass
    ...
    out_dom_trust_list = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
