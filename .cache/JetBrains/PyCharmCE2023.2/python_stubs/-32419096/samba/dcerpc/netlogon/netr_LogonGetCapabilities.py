...
class netr_LogonGetCapabilities(__talloc.BaseObject):
    # no doc
    @classmethod
    def opnum(cls): # real signature unknown; restored from __doc__
        """ netlogon.netr_LogonGetCapabilities.opnum() -> 21 (0x15) """
        pass
    ...
    in_query_level = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    ...
    out_capabilities = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type netr_Capabilities"""
