...
class UserLevelCtr(__talloc.BaseObject):
    # no doc
    ...
    user_info = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type spoolss_UserLevel"""
