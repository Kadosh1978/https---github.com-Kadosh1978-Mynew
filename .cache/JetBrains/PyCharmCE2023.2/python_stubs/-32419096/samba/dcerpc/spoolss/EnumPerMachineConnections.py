...
class EnumPerMachineConnections(__talloc.BaseObject):
    # no doc
    @classmethod
    def opnum(cls): # real signature unknown; restored from __doc__
        """ spoolss.EnumPerMachineConnections.opnum() -> 87 (0x57) """
        pass
    ...
    """PIDL-generated element of base type spoolss_PrinterInfo4"""
