...
class SendRecvBidiData(__talloc.BaseObject):
    # no doc
    @classmethod
    def opnum(cls): # real signature unknown; restored from __doc__
        """ spoolss.SendRecvBidiData.opnum() -> 97 (0x61) """
        pass
    ...
    in_pAction = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type uint16"""

    in_pReqData = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type RPC_BIDI_REQUEST_CONTAINER"""

    out_ppRespData = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type RPC_BIDI_RESPONSE_CONTAINER"""
