...
class RouterRefreshPrinterChangeNotify(__talloc.BaseObject):
    # no doc
    @classmethod
    def opnum(cls): # real signature unknown; restored from __doc__
        """ spoolss.RouterRefreshPrinterChangeNotify.opnum() -> 67 (0x43) """
        pass
    ...
    in_change_low = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    ...
    """PIDL-generated element of base type spoolss_NotifyInfo"""
