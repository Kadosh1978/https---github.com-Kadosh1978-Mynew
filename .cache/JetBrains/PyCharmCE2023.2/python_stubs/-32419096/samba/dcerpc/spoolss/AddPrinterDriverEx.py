...
class AddPrinterDriverEx(__talloc.BaseObject):
    # no doc
    @classmethod
    def opnum(cls): # real signature unknown; restored from __doc__
        """ spoolss.AddPrinterDriverEx.opnum() -> 89 (0x59) """
        pass
    ...
    """PIDL-generated element of base type spoolss_AddPrinterDriverExFlags"""
