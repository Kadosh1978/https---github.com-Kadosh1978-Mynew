...
class GetPrinterDriverDirectory(__talloc.BaseObject):
    # no doc
    @classmethod
    def opnum(cls): # real signature unknown; restored from __doc__
        """ spoolss.GetPrinterDriverDirectory.opnum() -> 12 (0x0c) """
        pass
    ...
    """PIDL-generated element of base type spoolss_DriverDirectoryInfo"""
