...
class AddPrinterEx(__talloc.BaseObject):
    # no doc
    @classmethod
    def opnum(cls): # real signature unknown; restored from __doc__
        """ spoolss.AddPrinterEx.opnum() -> 70 (0x46) """
        pass
    ...
    in_devmode_ctr = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    ...
    in_secdesc_ctr = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    ...
    in_userlevel_ctr = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
