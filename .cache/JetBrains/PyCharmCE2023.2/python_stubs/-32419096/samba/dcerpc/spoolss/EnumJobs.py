...
class EnumJobs(__talloc.BaseObject):
    # no doc
    @classmethod
    def opnum(cls): # real signature unknown; restored from __doc__
        """ spoolss.EnumJobs.opnum() -> 4 (0x04) """
        pass
    ...
    in_numjobs = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """PIDL-generated element of base type uint32"""
    ...
    """PIDL-generated element of base type spoolss_JobInfo"""
