...
class CorePrinterDriver(__talloc.BaseObject):
    # no doc
    ...
    core_driver_guid = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    ...
    szPackageID = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
