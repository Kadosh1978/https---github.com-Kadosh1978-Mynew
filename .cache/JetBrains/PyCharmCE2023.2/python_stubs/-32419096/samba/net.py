# encoding: utf-8
# module samba.net
# from /usr/lib/python3/dist-packages/samba/net.cpython-310-x86_64-linux-gnu.so
# by generator 1.147
# no doc
# no imports
...
class Net(object):
    ...
    def replicate_decrypt(self, drs, attribute, rid): # real signature unknown; restored from __doc__
        """
...
__spec__ = None # (!) real value is "ModuleSpec(name='samba.net', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f4211d2d540>, origin='/usr/lib/python3/dist-packages/samba/net.cpython-310-x86_64-linux-gnu.so')"
