...
# from /usr/lib/python3/dist-packages/samba/samba3/passdb.cpython-310-x86_64-linux-gnu.so
# by generator 1.147
...
def get_domain_sid(): # real signature unknown; restored from __doc__
    """
...
class Groupmap(__talloc.BaseObject):
...
class Samu(__talloc.BaseObject):
    """ Samu() -> samu object """
    def __init__(self): # real signature unknown; restored from __doc__
        pass
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f4211d3a950>'

__spec__ = None # (!) real value is "ModuleSpec(name='samba.samba3.passdb', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f4211d3a950>, origin='/usr/lib/python3/dist-packages/samba/samba3/passdb.cpython-310-x86_64-linux-gnu.so')"
