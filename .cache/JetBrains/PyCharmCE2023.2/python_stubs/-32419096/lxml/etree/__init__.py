...
def indent(tree, space="  ", level=0): # real signature unknown; restored from __doc__
    """
...
from .XMLSyntaxAssertionError import XMLSyntaxAssertionError
...
memory_debugger = None # (!) real value is '<lxml.etree._MemDebug object at 0x7f7180328ce0>'
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f717fa45c30>'

__pyx_capi__ = {
    'adoptExternalDocument': None, # (!) real value is '<capsule object "struct LxmlElementTree *(xmlDoc *, PyObject *, int)" at 0x7f717fa566d0>'
    'appendChild': None, # (!) real value is '<capsule object "void (struct LxmlElement *, struct LxmlElement *)" at 0x7f717fa56d00>'
    'appendChildToElement': None, # (!) real value is '<capsule object "int (struct LxmlElement *, struct LxmlElement *)" at 0x7f717fa56cd0>'
    'attributeValue': None, # (!) real value is '<capsule object "PyObject *(xmlNode *, xmlAttr *)" at 0x7f717fa56a00>'
    'attributeValueFromNsName': None, # (!) real value is '<capsule object "PyObject *(xmlNode *, const xmlChar *, const xmlChar *)" at 0x7f717fa56a30>'
    'callLookupFallback': None, # (!) real value is '<capsule object "PyObject *(struct LxmlFallbackElementClassLookup *, struct LxmlDocument *, xmlNode *)" at 0x7f717fa56820>'
    'collectAttributes': None, # (!) real value is '<capsule object "PyObject *(xmlNode *, int)" at 0x7f717fa56ac0>'
    'deepcopyNodeToDocument': None, # (!) real value is '<capsule object "struct LxmlElement *(struct LxmlDocument *, xmlNode *)" at 0x7f717fa55a40>'
    'delAttribute': None, # (!) real value is '<capsule object "int (struct LxmlElement *, PyObject *)" at 0x7f717fa56e80>'
    'delAttributeFromNsName': None, # (!) real value is '<capsule object "int (xmlNode *, const xmlChar *, const xmlChar *)" at 0x7f717fa56e50>'
    'documentOrRaise': None, # (!) real value is '<capsule object "struct LxmlDocument *(PyObject *)" at 0x7f717fa56880>'
    'elementFactory': None, # (!) real value is '<capsule object "struct LxmlElement *(struct LxmlDocument *, xmlNode *)" at 0x7f717fa56700>'
    'elementTreeFactory': None, # (!) real value is '<capsule object "struct LxmlElementTree *(struct LxmlElement *)" at 0x7f717fa56670>'
    'findChild': None, # (!) real value is '<capsule object "xmlNode *(xmlNode *, Py_ssize_t)" at 0x7f717fa56df0>'
    'findChildBackwards': None, # (!) real value is '<capsule object "xmlNode *(xmlNode *, Py_ssize_t)" at 0x7f717fa56d90>'
    'findChildForwards': None, # (!) real value is '<capsule object "xmlNode *(xmlNode *, Py_ssize_t)" at 0x7f717fa56dc0>'
    'findOrBuildNodeNsPrefix': None, # (!) real value is '<capsule object "xmlNs *(struct LxmlDocument *, xmlNode *, const xmlChar *, const xmlChar *)" at 0x7f717fa56640>'
    'getAttributeValue': None, # (!) real value is '<capsule object "PyObject *(struct LxmlElement *, PyObject *, PyObject *)" at 0x7f717fa56a60>'
    'getNsTag': None, # (!) real value is '<capsule object "PyObject *(PyObject *)" at 0x7f717fa56c40>'
    'getNsTagWithEmptyNs': None, # (!) real value is '<capsule object "PyObject *(PyObject *)" at 0x7f717fa56c10>'
    'hasChild': None, # (!) real value is '<capsule object "int (xmlNode *)" at 0x7f717fa56e20>'
    'hasTail': None, # (!) real value is '<capsule object "int (xmlNode *)" at 0x7f717fa56910>'
    'hasText': None, # (!) real value is '<capsule object "int (xmlNode *)" at 0x7f717fa568e0>'
    'initTagMatch': None, # (!) real value is '<capsule object "void (struct LxmlElementTagMatcher *, PyObject *)" at 0x7f717fa56b20>'
    'iteratorStoreNext': None, # (!) real value is '<capsule object "void (struct LxmlElementIterator *, struct LxmlElement *)" at 0x7f717fa56b50>'
    'iterattributes': None, # (!) real value is '<capsule object "PyObject *(struct LxmlElement *, int)" at 0x7f717fa56a90>'
    'lookupDefaultElementClass': None, # (!) real value is '<capsule object "PyObject *(PyObject *, PyObject *, xmlNode *)" at 0x7f717fa567c0>'
    'lookupNamespaceElementClass': None, # (!) real value is '<capsule object "PyObject *(PyObject *, PyObject *, xmlNode *)" at 0x7f717fa567f0>'
    'makeElement': None, # (!) real value is '<capsule object "struct LxmlElement *(PyObject *, struct LxmlDocument *, PyObject *, PyObject *, PyObject *, PyObject *, PyObject *)" at 0x7f717fa56730>'
    'makeSubElement': None, # (!) real value is '<capsule object "struct LxmlElement *(struct LxmlElement *, PyObject *, PyObject *, PyObject *, PyObject *, PyObject *)" at 0x7f717fa56760>'
    'namespacedName': None, # (!) real value is '<capsule object "PyObject *(xmlNode *)" at 0x7f717fa56be0>'
    'namespacedNameFromNsName': None, # (!) real value is '<capsule object "PyObject *(const xmlChar *, const xmlChar *)" at 0x7f717fa56b80>'
    'newElementTree': None, # (!) real value is '<capsule object "struct LxmlElementTree *(struct LxmlElement *, PyObject *)" at 0x7f717fa566a0>'
    'nextElement': None, # (!) real value is '<capsule object "xmlNode *(xmlNode *)" at 0x7f717fa56d60>'
    'previousElement': None, # (!) real value is '<capsule object "xmlNode *(xmlNode *)" at 0x7f717fa56d30>'
    'pyunicode': None, # (!) real value is '<capsule object "PyObject *(const xmlChar *)" at 0x7f717fa56ca0>'
    'rootNodeOrRaise': None, # (!) real value is '<capsule object "struct LxmlElement *(PyObject *)" at 0x7f717fa568b0>'
    'setAttributeValue': None, # (!) real value is '<capsule object "int (struct LxmlElement *, PyObject *, PyObject *)" at 0x7f717fa56af0>'
    'setElementClassLookupFunction': None, # (!) real value is '<capsule object "void (_element_class_lookup_function, PyObject *)" at 0x7f717fa56790>'
    'setNodeText': None, # (!) real value is '<capsule object "int (xmlNode *, PyObject *)" at 0x7f717fa569a0>'
    'setTailText': None, # (!) real value is '<capsule object "int (xmlNode *, PyObject *)" at 0x7f717fa569d0>'
    'tagMatches': None, # (!) real value is '<capsule object "int (xmlNode *, const xmlChar *, const xmlChar *)" at 0x7f717fa56850>'
    'tailOf': None, # (!) real value is '<capsule object "PyObject *(xmlNode *)" at 0x7f717fa56970>'
    'textOf': None, # (!) real value is '<capsule object "PyObject *(xmlNode *)" at 0x7f717fa56940>'
    'utf8': None, # (!) real value is '<capsule object "PyObject *(PyObject *)" at 0x7f717fa56c70>'
}

__spec__ = None # (!) real value is "ModuleSpec(name='lxml.etree', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f717fa45c30>, origin='/home/kadosh/PycharmProjects/Weather/venv/lib/python3.10/site-packages/lxml/etree.cpython-310-x86_64-linux-gnu.so')"

__test__ = {
    'FunctionNamespace (line 207)': 'FunctionNamespace(ns_uri)\n\n    Retrieve the function namespace object associated with the given\n    URI.\n\n    Creates a new one if it does not yet exist. A function namespace\n    can only be used to register extension functions.\n\n    Usage:\n\n    >>> ns_functions = FunctionNamespace("http://schema.org/Movie")\n\n    >>> @ns_functions  # uses function name\n    ... def add2(x):\n    ...     return x + 2\n\n    >>> @ns_functions("add3")  # uses explicit name\n    ... def add_three(x):\n    ...     return x + 3\n    ',
    'XML (line 3211)': 'XML(text, parser=None, base_url=None)\n\n    Parses an XML document or fragment from a string constant.\n    Returns the root node (or the result returned by a parser target).\n    This function can be used to embed "XML literals" in Python code,\n    like in\n\n       >>> root = XML("<root><test/></root>")\n       >>> print(root.tag)\n       root\n\n    To override the parser with a different ``XMLParser`` you can pass it to\n    the ``parser`` keyword argument.\n\n    The ``base_url`` keyword argument allows to set the original base URL of\n    the document to support relative Paths when looking up external entities\n    (DTD, XInclude, ...).\n    ',
}
