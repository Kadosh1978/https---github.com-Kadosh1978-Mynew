...
# from /home/kadosh/.local/lib/python3.10/site-packages/gevent/libuv/_corecffi.abi3.so
# by generator 1.147
# no doc

# imports
from _cffi_backend import (_uv_close_callback, python_callback, 
...
def gevent_set_uv_alloc(): # real signature unknown; restored from __doc__
    """
    void gevent_set_uv_alloc();
    
    CFFI C function from gevent.libuv._corecffi.lib
    """
    pass

def gevent_test_setup(): # real signature unknown; restored from __doc__
    """
    void gevent_test_setup();
...
def uv_available_parallelism(): # real signature unknown; restored from __doc__
    """
...
def uv_poll_init_socket(struct_uv_loop_s, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
    """
    int uv_poll_init_socket(struct uv_loop_s *, struct uv_poll_s *, int);
