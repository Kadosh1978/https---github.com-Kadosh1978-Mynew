# encoding: utf-8
# module gevent._gevent_c_hub_primitives
# from /home/kadosh/.local/lib/python3.10/site-packages/gevent/_gevent_c_hub_primitives.cpython-310-x86_64-linux-gnu.so
# by generator 1.147
"""
...
from gevent._gevent_c_greenlet_primitives import SwitchOutGreenletWithLoop

from gevent._gevent_c_hub_local import get_hub_noargs

from gevent._gevent_c_waiter import MultipleWaiter, Waiter

from greenlet._greenlet import getcurrent

import gevent._gevent_c_greenlet_primitives as __gevent__gevent_c_greenlet_primitives
...
class WaitOperationsGreenlet(__gevent__gevent_c_greenlet_primitives.SwitchOutGreenletWithLoop):
    # no doc
    ...
    def cancel_waits_close_and_then(self, watchers, exc_kind, then, *then_args): # real signature unknown; restored from __doc__
    ...
    def _cancel_waits_then(self, watchers, exc_kind, then, then_args): # real signature unknown; restored from __doc__
        """ WaitOperationsGreenlet._cancel_waits_then(self, watchers, exc_kind, then, then_args) """
        pass
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x7f75169ce130>'
...
class _WaitIterator(object):
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x7f75169ce0d0>'
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f75169ce3e0>'

__pyx_capi__ = {
    'InvalidSwitchError': None, # (!) real value is '<capsule object "PyObject *" at 0x7f75169ce4c0>'
    'Timeout': None, # (!) real value is '<capsule object "PyObject *" at 0x7f75169ce340>'
    '_greenlet_imported': None, # (!) real value is '<capsule object "int" at 0x7f75169ce310>'
    '_greenlet_primitives': None, # (!) real value is '<capsule object "PyObject *" at 0x7f75169ce430>'
    '_primitive_wait': None, # (!) real value is '<capsule object "PyObject *(PyObject *, PyObject *, PyObject *, struct __pyx_obj_6gevent_24_gevent_c_hub_primitives_WaitOperationsGreenlet *)" at 0x7f75169ce280>'
    '_timeout_error': None, # (!) real value is '<capsule object "PyObject *" at 0x7f75169ce370>'
    '_waiter': None, # (!) real value is '<capsule object "PyObject *" at 0x7f75169ce400>'
    'iwait_on_objects': None, # (!) real value is '<capsule object "PyObject *(PyObject *, int __pyx_skip_dispatch, struct __pyx_opt_args_6gevent_24_gevent_c_hub_primitives_iwait_on_objects *__pyx_optional_args)" at 0x7f75169ce2e0>'
    'traceback': None, # (!) real value is '<capsule object "PyObject *" at 0x7f75169ce3a0>'
    'wait_on_objects': None, # (!) real value is '<capsule object "PyObject *(int __pyx_skip_dispatch, struct __pyx_opt_args_6gevent_24_gevent_c_hub_primitives_wait_on_objects *__pyx_optional_args)" at 0x7f75169ce2b0>'
    'wait_on_socket': None, # (!) real value is '<capsule object "PyObject *(PyObject *, PyObject *, int __pyx_skip_dispatch, struct __pyx_opt_args_6gevent_24_gevent_c_hub_primitives_wait_on_socket *__pyx_optional_args)" at 0x7f75169ce190>'
    'wait_on_watcher': None, # (!) real value is '<capsule object "PyObject *(PyObject *, int __pyx_skip_dispatch, struct __pyx_opt_args_6gevent_24_gevent_c_hub_primitives_wait_on_watcher *__pyx_optional_args)" at 0x7f75169ce250>'
    'wait_read': None, # (!) real value is '<capsule object "PyObject *(PyObject *, int __pyx_skip_dispatch, struct __pyx_opt_args_6gevent_24_gevent_c_hub_primitives_wait_read *__pyx_optional_args)" at 0x7f75169ce220>'
    'wait_readwrite': None, # (!) real value is '<capsule object "PyObject *(PyObject *, int __pyx_skip_dispatch, struct __pyx_opt_args_6gevent_24_gevent_c_hub_primitives_wait_readwrite *__pyx_optional_args)" at 0x7f75169ce1c0>'
    'wait_write': None, # (!) real value is '<capsule object "PyObject *(PyObject *, int __pyx_skip_dispatch, struct __pyx_opt_args_6gevent_24_gevent_c_hub_primitives_wait_write *__pyx_optional_args)" at 0x7f75169ce1f0>'
}

__spec__ = None # (!) real value is "ModuleSpec(name='gevent._gevent_c_hub_primitives', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f75169ce3e0>, origin='/home/kadosh/.local/lib/python3.10/site-packages/gevent/_gevent_c_hub_primitives.cpython-310-x86_64-linux-gnu.so')"
