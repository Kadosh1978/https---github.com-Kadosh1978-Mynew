# encoding: utf-8
# module gevent._gevent_c_waiter
# from /home/kadosh/.local/lib/python3.10/site-packages/gevent/_gevent_c_waiter.cpython-310-x86_64-linux-gnu.so
# by generator 1.147
...
class Waiter(object):
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x7f75169ce940>'
    __slots__ = [
        'hub',
        'greenlet',
        'value',
...
class MultipleWaiter(Waiter):
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x7f75169ce8e0>'
    __slots__ = [
        '_values',
    ]
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f75169ce9e0>'

__pyx_capi__ = {
    'ConcurrentObjectUseError': None, # (!) real value is '<capsule object "PyObject *" at 0x7f75169cea00>'
    '_NONE': None, # (!) real value is '<capsule object "PyObject *" at 0x7f75169ce9a0>'
    '_greenlet_imported': None, # (!) real value is '<capsule object "int" at 0x7f75169cea30>'
    'sys': None, # (!) real value is '<capsule object "PyObject *" at 0x7f75169ceac0>'
}

__spec__ = None # (!) real value is "ModuleSpec(name='gevent._gevent_c_waiter', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f75169ce9e0>, origin='/home/kadosh/.local/lib/python3.10/site-packages/gevent/_gevent_c_waiter.cpython-310-x86_64-linux-gnu.so')"
