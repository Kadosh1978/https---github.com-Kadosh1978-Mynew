...
openssl_md_meth_names = None # (!) real value is "frozenset({'shake_128', 'sha512_256', 'sha3_224', 'sha256', 'blake2s', 'sha3_512', 'sha3_256', 'blake2b', 'sha512_224', 'shake_256', 'sha224', 'sha1', 'sha384', 'sm3', 'sha512', 'md5', 'sha3_384', 'md5-sha1'})"
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7fe80618e2c0>'

__spec__ = None # (!) real value is "ModuleSpec(name='_hashlib', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7fe80618e2c0>, origin='/usr/lib/python3.10/lib-dynload/_hashlib.cpython-310-x86_64-linux-gnu.so')"
