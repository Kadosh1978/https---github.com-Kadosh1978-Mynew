...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7fe80616f6a0>'

__spec__ = None # (!) real value is "ModuleSpec(name='_lzma', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7fe80616f6a0>, origin='/usr/lib/python3.10/lib-dynload/_lzma.cpython-310-x86_64-linux-gnu.so')"
