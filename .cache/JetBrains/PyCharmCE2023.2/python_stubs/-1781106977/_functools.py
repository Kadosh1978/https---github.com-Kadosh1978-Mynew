...
class _lru_cache_wrapper(object):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__new__': <built-in method __new__ of type object at 0x56336ba77860>, '__call__': <slot wrapper '__call__' of 'functools._lru_cache_wrapper' objects>, '__get__': <slot wrapper '__get__' of 'functools._lru_cache_wrapper' objects>, 'cache_info': <method 'cache_info' of 'functools._lru_cache_wrapper' objects>, 'cache_clear': <method 'cache_clear' of 'functools._lru_cache_wrapper' objects>, '__reduce__': <method '__reduce__' of 'functools._lru_cache_wrapper' objects>, '__copy__': <method '__copy__' of 'functools._lru_cache_wrapper' objects>, '__deepcopy__': <method '__deepcopy__' of 'functools._lru_cache_wrapper' objects>, '__dict__': <attribute '__dict__' of 'functools._lru_cache_wrapper' objects>, '__doc__': 'Create a cached callable that wraps another function.\\n\\nuser_function:      the function being cached\\n\\nmaxsize:  0         for no caching\\n          None      for unlimited cache size\\n          n         for a bounded cache\\n\\ntyped:    False     cache f(3) and f(3.0) as identical calls\\n          True      cache f(3) and f(3.0) as distinct calls\\n\\ncache_info_type:    namedtuple class with the fields:\\n                        hits misses currsize maxsize\\n', '__module__': 'functools'})"
