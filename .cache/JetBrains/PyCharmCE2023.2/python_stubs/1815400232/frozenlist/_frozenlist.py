...
# from /home/kadosh/PycharmProjects/WeatherEnglish/venv/lib/python3.10/site-packages/frozenlist/_frozenlist.cpython-310-x86_64-linux-gnu.so
# by generator 1.147
# no doc
...
class FrozenList(object):
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x7f8c528a6550>'
...
class MutableSequence(__collections_abc.Sequence):
    ...
    _abc_impl = None # (!) real value is '<_abc._abc_data object at 0x7f8c5300a6c0>'
    __abstractmethods__ = frozenset({'__len__', 'insert', '__delitem__', '__setitem__', '__getitem__'})
    __slots__ = ()


# variables with complex values

__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f8c528a66b0>'

__spec__ = None # (!) real value is "ModuleSpec(name='frozenlist._frozenlist', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f8c528a66b0>, origin='/home/kadosh/PycharmProjects/Weather/venv/lib/python3.10/site-packages/frozenlist/_frozenlist.cpython-310-x86_64-linux-gnu.so')"
