...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f4ab867c070>'

__spec__ = None # (!) real value is "ModuleSpec(name='_json', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f4ab867c070>, origin='/usr/lib/python3.10/lib-dynload/_json.cpython-310-x86_64-linux-gnu.so')"
