...
# from /home/kadosh/PycharmProjects/Weather/venv/lib/python3.10/site-packages/lxml/html/clean.cpython-310-x86_64-linux-gnu.so
# by generator 1.147
"""
...
import copy as copy # /usr/lib/python3.10/copy.py
import re as re # /usr/lib/python3.10/re.py
import sys as sys # <module 'sys' (built-in)>
import lxml.etree as etree # /home/kadosh/PycharmProjects/Weather/venv/lib/python3.10/site-packages/lxml/etree.cpython-310-x86_64-linux-gnu.so
import lxml.html.defs as defs # /home/kadosh/PycharmProjects/Weather/venv/lib/python3.10/site-packages/lxml/html/defs.py
...
def _find_image_dataurls(*args, **kwargs): # real signature unknown
...
def _has_javascript_scheme(*args, **kwargs): # real signature unknown
    pass

def _insert_break(*args, **kwargs): # real signature unknown
    pass

def _is_unsafe_image_type(*args, **kwargs): # real signature unknown
    pass

def _link_text(*args, **kwargs): # real signature unknown
    pass

def _looks_like_tag_content(*args, **kwargs): # real signature unknown
    pass

def _possibly_malicious_schemes(*args, **kwargs): # real signature unknown
    """ Return a list of all non-overlapping matches of pattern in string. """
    pass

def _replace_css_import(*args, **kwargs): # real signature unknown
    pass

def _replace_css_javascript(*args, **kwargs): # real signature unknown
    pass
...
class Cleaner(object):
    ...
    __dict__ = None # (!) real value is 'mappingproxy({\'__module__\': \'lxml.html.clean\', \'__doc__\': \'\\n    Instances cleans the document of each of the possible offending\\n    elements.  The cleaning is controlled by attributes; you can\\n    override attributes in a subclass, or set them in the constructor.\\n\\n    ``scripts``:\\n        Removes any ``<script>`` tags.\\n\\n    ``javascript``:\\n        Removes any Javascript, like an ``onclick`` attribute. Also removes stylesheets\\n        as they could contain Javascript.\\n\\n    ``comments``:\\n        Removes any comments.\\n\\n    ``style``:\\n        Removes any style tags.\\n\\n    ``inline_style``\\n        Removes any style attributes.  Defaults to the value of the ``style`` option.\\n\\n    ``links``:\\n        Removes any ``<link>`` tags\\n\\n    ``meta``:\\n        Removes any ``<meta>`` tags\\n\\n    ``page_structure``:\\n        Structural parts of a page: ``<head>``, ``<html>``, ``<title>``.\\n\\n    ``processing_instructions``:\\n        Removes any processing instructions.\\n\\n    ``embedded``:\\n        Removes any embedded objects (flash, iframes)\\n\\n    ``frames``:\\n        Removes any frame-related tags\\n\\n    ``forms``:\\n        Removes any form tags\\n\\n    ``annoying_tags``:\\n        Tags that aren\\\'t *wrong*, but are annoying.  ``<blink>`` and ``<marquee>``\\n\\n    ``remove_tags``:\\n        A list of tags to remove.  Only the tags will be removed,\\n        their content will get pulled up into the parent tag.\\n\\n    ``kill_tags``:\\n        A list of tags to kill.  Killing also removes the tag\\\'s content,\\n        i.e. the whole subtree, not just the tag itself.\\n\\n    ``allow_tags``:\\n        A list of tags to include (default include all).\\n\\n    ``remove_unknown_tags``:\\n        Remove any tags that aren\\\'t standard parts of HTML.\\n\\n    ``safe_attrs_only``:\\n        If true, only include \\\'safe\\\' attributes (specifically the list\\n        from the feedparser HTML sanitisation web site).\\n\\n    ``safe_attrs``:\\n        A set of attribute names to override the default list of attributes\\n        considered \\\'safe\\\' (when safe_attrs_only=True).\\n\\n    ``add_nofollow``:\\n        If true, then any <a> tags will have ``rel="nofollow"`` added to them.\\n\\n    ``host_whitelist``:\\n        A list or set of hosts that you can use for embedded content\\n        (for content like ``<object>``, ``<link rel="stylesheet">``, etc).\\n        You can also implement/override the method\\n        ``allow_embedded_url(el, url)`` or ``allow_element(el)`` to\\n        implement more complex rules for what can be embedded.\\n        Anything that passes this test will be shown, regardless of\\n        the value of (for instance) ``embedded``.\\n\\n        Note that this parameter might not work as intended if you do not\\n        make the links absolute before doing the cleaning.\\n\\n        Note that you may also need to set ``whitelist_tags``.\\n\\n    ``whitelist_tags``:\\n        A set of tags that can be included with ``host_whitelist``.\\n        The default is ``iframe`` and ``embed``; you may wish to\\n        include other tags like ``script``, or you may want to\\n        implement ``allow_embedded_url`` for more control.  Set to None to\\n        include all tags.\\n\\n    This modifies the document *in place*.\\n    \', \'scripts\': True, \'javascript\': True, \'comments\': True, \'style\': False, \'inline_style\': None, \'links\': True, \'meta\': True, \'page_structure\': True, \'processing_instructions\': True, \'embedded\': True, \'frames\': True, \'forms\': True, \'annoying_tags\': True, \'remove_tags\': None, \'allow_tags\': None, \'kill_tags\': None, \'remove_unknown_tags\': True, \'safe_attrs_only\': True, \'safe_attrs\': frozenset({\'action\', \'multiple\', \'enctype\', \'disabled\', \'datetime\', \'title\', \'usemap\', \'vspace\', \'readonly\', \'target\', \'value\', \'nohref\', \'border\', \'method\', \'src\', \'id\', \'checked\', \'axis\', \'hreflang\', \'rev\', \'shape\', \'compact\', \'dir\', \'cols\', \'accept-charset\', \'longdesc\', \'start\', \'cite\', \'summary\', \'rowspan\', \'alt\', \'accesskey\', \'coords\', \'frame\', \'href\', \'scope\', \'height\', \'name\', \'maxlength\', \'noshade\', \'prompt\', \'media\', \'lang\', \'rules\', \'for\', \'abbr\', \'headers\', \'accept\', \'colspan\', \'width\', \'valign\', \'nowrap\', \'charset\', \'color\', \'cellspacing\', \'rel\', \'rows\', \'span\', \'label\', \'charoff\', \'ismap\', \'size\', \'selected\', \'cellpadding\', \'clear\', \'char\', \'class\', \'tabindex\', \'hspace\', \'align\', \'type\'}), \'add_nofollow\': False, \'host_whitelist\': (), \'whitelist_tags\': {\'embed\', \'iframe\'}, \'__init__\': <cyfunction Cleaner.__init__ at 0x7f717f83cba0>, \'_tag_link_attrs\': {\'script\': \'src\', \'link\': \'href\', \'applet\': [\'code\', \'object\'], \'iframe\': \'src\', \'embed\': \'src\', \'layer\': \'src\', \'a\': \'href\'}, \'__call__\': <cyfunction Cleaner.__call__ at 0x7f717f288ee0>, \'allow_follow\': <cyfunction Cleaner.allow_follow at 0x7f717f288c70>, \'allow_element\': <cyfunction Cleaner.allow_element at 0x7f717f288e10>, \'allow_embedded_url\': <cyfunction Cleaner.allow_embedded_url at 0x7f717f288fb0>, \'kill_conditional_comments\': <cyfunction Cleaner.kill_conditional_comments at 0x7f717f289080>, \'_kill_elements\': <cyfunction Cleaner._kill_elements at 0x7f717f289150>, \'_remove_javascript_link\': <cyfunction Cleaner._remove_javascript_link at 0x7f717f289220>, \'_substitute_comments\': <built-in method sub of re.Pattern object at 0x7f717f28e260>, \'_has_sneaky_javascript\': <cyfunction Cleaner._has_sneaky_javascript at 0x7f717f2892f0>, \'clean_html\': <cyfunction Cleaner.clean_html at 0x7f717f2893c0>, \'__dict__\': <attribute \'__dict__\' of \'Cleaner\' objects>, \'__weakref__\': <attribute \'__weakref__\' of \'Cleaner\' objects>})'
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f717fa46ce0>'

__spec__ = None # (!) real value is "ModuleSpec(name='lxml.html.clean', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f717fa46ce0>, origin='/home/kadosh/PycharmProjects/Weather/venv/lib/python3.10/site-packages/lxml/html/clean.cpython-310-x86_64-linux-gnu.so')"
